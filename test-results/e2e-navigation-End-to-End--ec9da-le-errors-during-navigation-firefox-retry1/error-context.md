...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e574]:
    - generic [ref=e575]:
      - generic [ref=e576]: Nova versão disponível! 🎉
      - generic [ref=e577]: Clique em atualizar para obter as últimas melhorias
    - button "Atualizar" [ref=e578] [cursor=pointer]
    - button "Depois" [ref=e579] [cursor=pointer]
```