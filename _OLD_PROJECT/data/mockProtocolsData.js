import { ProtocolCategory, EvidenceLevel, ProtocolPhase } from '../types';
export const mockProtocolReferences = [
    {
        id: 'ref_1',
...
export const mockAssessmentTools = [
    {
        id: 'tool_1',
...
export const mockOutcomeMetrics = [
    {
        id: 'metric_1',
...
export const mockProtocolAnalytics = [
    {
...
export const mockProtocolLibraryStats = {
    totalProtocols: 3,
    protocolsByCategory: {
        'Ortopedia': 2,
        'Neurologia': 1,
...
export const mockProtocolPrescriptions = [
    {
        id: 'prescription_1',
        protocolId: 'protocol_lca_1',
        patientId: '1',
