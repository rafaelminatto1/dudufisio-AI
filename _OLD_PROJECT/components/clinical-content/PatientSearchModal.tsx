...
import { mockPatientService, type Patient } from '../../services/mockPatientService';
...
export default function PatientSearchModal({ 
  ...
  const handleRemoveAssignment = (patientId: string) => {
        ...
        <div className="p-6">
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {assignedPatients.map(patientId => {
                  ...
                  return (
                    <div key={patientId} className="bg-green-50 border border-green-200 rounded-lg p-3">
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          onClick={() => handleRemoveAssignment(patientId)}
          ...
          <div className="flex gap-4">
            <button
              ...
              disabled={!selectedPatient || assignedPatients.includes(selectedPatient.id)}
