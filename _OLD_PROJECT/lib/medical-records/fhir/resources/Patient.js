...
export class Patient {
     ...
     */
    getCPF() {
        const cpf = this.data.identifier?.find(id => id.system === 'http://www.saude.gov.br/fhir/r4/CodeSystem/BRIdentificador' &&
     ...
     */
    getCNS() {
        const cns = this.data.identifier?.find(id => id.system === 'http://www.saude.gov.br/fhir/r4/CodeSystem/BRIdentificador' &&
