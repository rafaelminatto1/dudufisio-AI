...
import { Supply, CreateSupplyData, UpdateSupplyData, SupplyCategory } from '../../types';
import { X, Save, Package } from 'lucide-react';

interface SupplyFormProps {
  supply?: Supply;
  onSave: (data: CreateSupplyData | UpdateSupplyData) => Promise<void>;
  onCancel: () => void;
  isLoading?: boolean;
}
...
const SupplyForm: React.FC<SupplyFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const submitData = supply 
        ? { id: supply.id, ...formData } as UpdateSupplyData
        : formData as CreateSupplyData;
  ...
  const handleInputChange = (field: keyof CreateSupplyData, value: any) => {
    setFormData(prev => ({
      ...prev,
      [field]: value
    }));
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  placeholder="Ex: Eletrodos Autoadesivos"
                />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange('unitCost', e.target.value ? parseFloat(e.target.value) : undefined)}
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange('expirationDate', e.target.value || undefined)}
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
