...
interface TimelineEvent {
  ...
  title: string;
  description: string;
  type: 'assessment' | 'evolution' | 'other';
  documentId?: string;
}
...
export function ClinicalTimeline({ events, onEventClick }: ClinicalTimelineProps) {
                ...
                return (
                  <div
                    ...
                    className={`relative flex items-start space-x-4 ${
                      onEventClick ? 'cursor-pointer hover:bg-gray-50 rounded-lg p-2 -ml-2' : ''
                    }`}
