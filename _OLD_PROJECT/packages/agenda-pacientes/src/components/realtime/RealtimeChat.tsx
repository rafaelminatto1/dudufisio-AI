...
export const RealtimeChat: React.FC<RealtimeChatProps> = ({
  ...
  const { sendMessage } = useBroadcast<ChatMessage>(
    `chat-${roomId}`,
    (payload) => {
              ...
              >
                ...
                <p
                  className={`text-xs mt-1 ${
                    msg.user_id === userId ? 'text-blue-100' : 'text-gray-400'
                  }`}
                >
      ...
      <div className="p-4 border-t bg-white">
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-4 bg-blue-500 text-white rounded-lg hover:bg-blue-600 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
          >
            <Send size={18} />
            Enviar
          </button>
