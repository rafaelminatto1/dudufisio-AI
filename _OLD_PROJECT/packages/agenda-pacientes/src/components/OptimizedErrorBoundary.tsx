...
interface Props {
  ...
  resetKeys?: any[]; // Reset quando keys mudarem
  showDetails?: boolean; // Mostrar detalhes do erro (dev only)
  level?: 'page' | 'component' | 'critical'; // Nível do boundary
}
...
class OptimizedErrorBoundary extends Component<Props, State> {
  ...
  private logError(error: Error, errorInfo: ErrorInfo, isErrorLoop: boolean) {
    const errorLog = {
          ...
          <Card className="max-w-2xl w-full">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                {!isErrorLoop && this.props.level !== 'critical' && (
