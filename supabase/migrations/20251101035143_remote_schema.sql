...
alter table if exists "public"."material_favorites" drop constraint if exists "material_favorites_material_id_fkey";
alter table if exists "public"."material_favorites" drop constraint if exists "material_favorites_user_id_fkey";
...
drop table if exists "public"."material_favorites";
...
alter table "public"."schedule_blocks" drop column if exists "created_by";
alter table "public"."schedule_blocks" drop column if exists "metadata";
alter table "public"."schedule_blocks" drop column if exists "reason";
alter table "public"."schedule_blocks" drop column if exists "recurrence_rule";
alter table "public"."schedule_blocks" add column if not exists "deleted_at" timestamp with time zone;
alter table "public"."schedule_blocks" add column if not exists "is_recurring" boolean default false;
alter table "public"."schedule_blocks" add column if not exists "recurrence_end_date" date;
alter table "public"."schedule_blocks" add column if not exists "recurrence_pattern" text;
...
CREATE INDEX IF NOT EXISTS idx_schedule_blocks_therapist ON public.schedule_blocks USING btree (therapist_id) WHERE (deleted_at IS NULL);
CREATE INDEX IF NOT EXISTS idx_schedule_blocks_active ON public.schedule_blocks USING btree (is_active);
