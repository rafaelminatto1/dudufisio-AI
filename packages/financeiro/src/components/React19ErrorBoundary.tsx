...
export class React19ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  private shouldResetError(prevResetKeys?: Array<string | number>, nextResetKeys?: Array<string | number>) {
 ...
 */
export function TeleconsultaErrorBoundary({ children }: { children: ReactNode }) {
  return (
    <React19ErrorBoundary
      fallback={
        <div className="p-6 bg-red-50 border border-red-200 rounded-lg">
