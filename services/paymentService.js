...
class PaymentService {
    ...
    async processStripePayment(payment, details) {
    ...
    async processMercadoPagoPayment(payment, details) {
    ...
    async processPagSeguroPayment(payment, details) {
    ...
    async processPixPayment(payment, details) {
        // Mock PIX processing
        return {
