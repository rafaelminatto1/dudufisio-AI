const getBlockForDate = (date, title, startHour, endHour, therapistId) => {
...
let availabilityBlocks = generateMockBlocks();
const delay = (ms) => new Promise(res => setTimeout(res, ms));
export const getAvailabilityBlocks = async () => {
    await delay(200);
    return [...availabilityBlocks];
};
export const saveAvailabilityBlock = async (blockData) => {
    await delay(300);
...
export const deleteAvailabilityBlock = async (id) => {
    await delay(300);
