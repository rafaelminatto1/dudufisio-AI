...
// ============================================================================
export const getTaskSuppliesUsed = async (taskId) => {
    try {
        const { data, error } = await supabase
...
export const createTaskSupplyUsed = async (supplyData) => {
    try {
...
export const deleteTaskSupplyUsed = async (id) => {
    try {
...
// ============================================================================
export const getTaskTypeSupplyTemplates = async (taskType) => {
    try {
        const { data, error } = await supabase
...
export const updateTaskTypeSupplyTemplate = async (id, templateData) => {
    try {
        const { data, error } = await supabase
            .from('task_type_supply_templates')
            .update({
...
// ============================================================================
export const getTaskCost = async (taskId) => {
    try {
        const { data, error } = await supabase
            .from('task_costs')
            .select('*')
...
export const calculateTaskCost = async (taskId) => {
    try {
...
// FUNÇÕES AUXILIARES
// ============================================================================
export const validateSupplyAvailability = async (supplyId, quantity) => {
    try {
...
export const getSuggestedSuppliesForTaskType = async (taskType) => {
    try {
...
export const consumeSuppliesForTask = async (taskId, supplies) => {
    try {
        const results = [];
