...
class SportsRehabServiceSupabase {
   ...
   */
  async upsertAthleteProfile(profile: Omit<AthleteProfile, 'id' | 'createdAt' | 'updatedAt'>): Promise<AthleteProfile> {
   ...
   */
  async getAthleteProfile(patientId: string): Promise<AthleteProfile | null> {
    const { data, error } = await supabase
      .from('athlete_profiles')
      .select('*')
   ...
   */
  async saveReturnToSportCriteria(
    criteria: Omit<ReturnToSportCriteria, 'id' | 'createdAt' | 'updatedAt'>
  ): Promise<ReturnToSportCriteria> {
    const { data, error } = await supabase
   ...
   */
  async getReturnToSportCriteria(athleteId: string): Promise<ReturnToSportCriteria[]> {
    const { data, error } = await supabase
      .from('return_to_sport_criteria')
      .select('*')
   ...
   */
  async saveFunctionalTest(test: Omit<FunctionalTest, 'id' | 'createdAt'>): Promise<FunctionalTest> {
    const { data, error } = await supabase
   ...
   */
  async getFunctionalTests(rtsCriteriaId: string): Promise<FunctionalTest[]> {
    const { data, error } = await supabase
      .from('functional_tests')
      .select('*')
   ...
   */
  async saveLoadMonitoring(load: Omit<LoadMonitoring, 'id' | 'createdAt'>): Promise<LoadMonitoring> {
    const { data, error } = await supabase
   ...
   */
  async getLoadMonitoring(athleteId: string, weeks?: number): Promise<LoadMonitoring[]> {
    let query = supabase
      .from('load_monitoring')
      .select('*')
      .eq('athlete_id', athleteId)
   ...
   */
  async updateRehabProgression(
    progression: Omit<RehabProgression, 'createdAt' | 'updatedAt'>
  ): Promise<RehabProgression> {
    const { data, error } = await supabase
   ...
   */
  async getRehabProgression(athleteId: string): Promise<RehabProgression | null> {
    const { data, error } = await supabase
      .from('rehab_progressions')
      .select('*')
      .eq('athlete_id', athleteId)
   ...
   */
  async getTrainingSessions(athleteId: string, limit?: number): Promise<SportTrainingSession[]> {
    let query = supabase
      .from('sport_training_sessions')
      .select('*')
      .eq('athlete_id', athleteId)
   ...
   */
  async getAthleteStatistics(athleteId: string): Promise<any> {
  ...
  private mapDatabaseToAthleteProfile(data: any): AthleteProfile {
    return {
      id: data.id,
  ...
  private mapDatabaseToRTSCriteria(data: any): ReturnToSportCriteria {
    return {
      id: data.id,
  ...
  private mapDatabaseToFunctionalTest(data: any): FunctionalTest {
    return {
      id: data.id,
  ...
  private mapDatabaseToPerformanceMetric(data: any): PerformanceMetric {
    return {
      id: data.id,
      athleteId: data.athlete_id,
  ...
  private mapDatabaseToLoadMonitoring(data: any): LoadMonitoring {
    return {
      id: data.id,
      athleteId: data.athlete_id,
  ...
  private mapDatabaseToRehabProgression(data: any): RehabProgression {
    return {
      id: data.id,
      athleteId: data.athlete_id,
      currentPhase: data.current_phase,
  ...
  private mapDatabaseToTrainingSession(data: any): SportTrainingSession {
    return {
      id: data.id,
      athleteId: data.athlete_id,
