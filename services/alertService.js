...
// ============================================================================
export const getAutoAlertRules = async () => {
    try {
...
export const createAutoAlertRule = async (ruleData) => {
    try {
        const { data, error } = await supabase
            .from('auto_alert_rules')
            .insert({
...
export const updateAutoAlertRule = async (id, ruleData) => {
    try {
        const { data, error } = await supabase
            .from('auto_alert_rules')
            .update({
...
// ============================================================================
export const getAlertHistory = async (alertId) => {
    try {
        const { data, error } = await supabase
            .from('alert_history')
            .select('*')
...
export const addAlertHistory = async (historyData) => {
    try {
        const { data, error } = await supabase
            .from('alert_history')
            .insert([{
...
// ============================================================================
export const getScheduledAlerts = async (status) => {
    try {
        let query = supabase
...
export const createScheduledAlert = async (alertData) => {
    try {
