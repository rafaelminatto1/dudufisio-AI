...
export class WhatsAppAutomation {
     ...
     */
    async processKeywordAutomation(message, phone, clinicId) {
     ...
     */
    async sendAutomatedReminders(clinicId) {
        try {
     ...
     */
    async processConfirmationResponse(message, phone, clinicId) {
        const messageLower = message.toLowerCase().trim();
...
export const getWhatsAppAutomation = () => {
