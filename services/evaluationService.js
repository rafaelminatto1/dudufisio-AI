...
const getEvaluationsFromStorage = () => {
...
const saveEvaluationsToStorage = (evaluations) => {
    sessionStorage.setItem(EVALUATIONS_KEY, JSON.stringify(evaluations));
};
export const getEvaluationsByPatientId = async (patientId) => {
...
export const addEvaluation = async (data) => {
    ...
    const filteredEvals = allEvals.filter(e => !(e.patientId === newEval.patientId &&
