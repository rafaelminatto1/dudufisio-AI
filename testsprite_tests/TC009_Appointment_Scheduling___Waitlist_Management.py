...
async def run_test():
    ...
    try:
        ...
        # -> Add a patient to the waitlist for a fully booked date and time by clicking a fully booked slot's 'Novo agendamento' button
        frame = context.pages[-1]
        # Click 'Novo agendamento' button at 07:30 to add a patient to waitlist for fully booked slot
        ...
        try:
            ...
            raise AssertionError("Test case failed: The waitlist handling and notification process did not complete successfully as per the test plan. Patient was not properly notified or scheduled after slot became available.")
