...
export const mockAppointments: Appointment[] = [
    ...
    // Agendamentos para Rafael Minatto de Martino na semana atual
    { id: 'app_rafael_1', patientId: 'rafael_minatto', patientName: 'Rafael Minatto de Martino', patientAvatarUrl: mockPatients.find(p => p.id === 'rafael_minatto')?.avatarUrl || '', therapistId: 'therapist_1', startTime: getFutureDate(2, 7, 30), endTime: getFutureDate(2, 8, 30), title: 'Avaliação Inicial', type: AppointmentType.Evaluation, status: AppointmentStatus.Scheduled, value: 150, paymentStatus: 'pending' },
    { id: 'app_rafael_2', patientId: 'rafael_minatto', patientName: 'Rafael Minatto de Martino', patientAvatarUrl: mockPatients.find(p => p.id === 'rafael_minatto')?.avatarUrl || '', therapistId: 'therapist_1', startTime: getFutureDate(2, 8, 30), endTime: getFutureDate(2, 9, 30), title: 'Sessão de Fortalecimento', type: AppointmentType.Session, status: AppointmentStatus.Scheduled, value: 120, paymentStatus: 'pending', sessionNumber: 1, totalSessions: 10 },
    { id: 'app_rafael_3', patientId: 'rafael_minatto', patientName: 'Rafael Minatto de Martino', patientAvatarUrl: mockPatients.find(p => p.id === 'rafael_minatto')?.avatarUrl || '', therapistId: 'therapist_1', startTime: getFutureDate(2, 9), endTime: getFutureDate(2, 10), title: 'Terapia Manual', type: AppointmentType.Session, status: AppointmentStatus.Scheduled, value: 120, paymentStatus: 'pending', sessionNumber: 2, totalSessions: 10 },
    { id: 'app_rafael_4', patientId: 'rafael_minatto', patientName: 'Rafael Minatto de Martino', patientAvatarUrl: mockPatients.find(p => p.id === 'rafael_minatto')?.avatarUrl || '', therapistId: 'therapist_1', startTime: getFutureDate(3, 7, 30), endTime: getFutureDate(3, 8, 30), title: 'Sessão de Alongamento', type: AppointmentType.Session, status: AppointmentStatus.Scheduled, value: 120, paymentStatus: 'paid', sessionNumber: 3, totalSessions: 10 },
    { id: 'app_rafael_5', patientId: 'rafael_minatto', patientName: 'Rafael Minatto de Martino', patientAvatarUrl: mockPatients.find(p => p.id === 'rafael_minatto')?.avatarUrl || '', therapistId: 'therapist_2', startTime: getFutureDate(4, 8, 30), endTime: getFutureDate(4, 9, 30), title: 'Pilates Clínico', type: AppointmentType.Session, status: AppointmentStatus.Scheduled, value: 130, paymentStatus: 'pending', sessionNumber: 4, totalSessions: 10 },
