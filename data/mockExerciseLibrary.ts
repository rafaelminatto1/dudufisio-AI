...
import { ExerciseCategory, Protocol, ProtocolCategory, EvidenceLevel, ProtocolPhase } from '../types';
...
export const mockProtocols: Protocol[] = [
  {
    ...
    references: [],
    definition: 'Protocolo para reabilitação pós-operatória de LCA',
    inclusionCriteria: ['Pós-operatório de LCA'],
    exclusionCriteria: [],
    contraindications: [],
    precautions: [],
    assessmentTools: [],
    ...
    progressionCriteria: [],
    dischargeCriteria: [],
    estimatedDuration: { min: 6, max: 12, unit: 'months' },
  ...
  },
  {
    ...
    evidenceLevel: EvidenceLevel.IIA,
    references: [],
    definition: 'Protocolo para tratamento de síndrome do impacto',
    inclusionCriteria: ['Síndrome do impacto'],
    exclusionCriteria: [],
    contraindications: [],
    precautions: [],
    assessmentTools: [],
  ...
  },
  {
    ...
    evidenceLevel: EvidenceLevel.IIA,
    references: [],
    definition: 'Protocolo para tratamento de lombalgia aguda',
    inclusionCriteria: ['Lombalgia aguda'],
    exclusionCriteria: [],
    contraindications: [],
    precautions: [],
    assessmentTools: [],
