...
const getFutureDate = (days, hours, minutes = 0) => {
...
export const mockRecurrenceTemplates = [
    {
        id: templateId,
        clinicId: undefined,
...
export const mockSchedulingAlerts = [
    {
...
export const mockExercisePrescriptions = [
    {
        id: 'ex1',
...
export const sampleVoucherPlans = [
    {
        id: 'plan_starter',
        name: 'Plano Foco',
...
export const mockEducationalCases = [
    {
        id: 'case_1',
...
export const mockEventProviders = [
