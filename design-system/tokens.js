...
export const getTherapistColor = (therapistId) => {
    ...
    return therapistColors[therapistId] || designTokens.colors.therapist[1];
};
export const getAppointmentStatusColor = (status) => {
    ...
    return statusColors[status] || designTokens.colors.neutral[400];
};
