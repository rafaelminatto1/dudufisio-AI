 ...
 * Breadcrumbs helpers
 */
export const getBreadcrumbs = (pathname, patientName) => {
    const breadcrumbs = [
    ...
    if (pathname.includes('/risk-stratification')) {
        ...
        if (patientName)
            breadcrumbs.push({ label: patientName });
    }
