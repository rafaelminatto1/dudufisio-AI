...
export class DataLoader {
    ...
    async loadDimensionPatients(data) {
        try {
    ...
    async loadDimensionTherapists(data) {
        try {
    ...
    async loadDimensionTreatments(data) {
        try {
    ...
    async loadFactAppointments(data) {
        try {
    ...
    async loadFactFinancialTransactions(data) {
        try {
    ...
    async loadFactClinicalOutcomes(data) {
        try {
    ...
    async loadFactPatientEngagement(data) {
        try {
    ...
    // Utility methods
    generateSurrogateKey(prefix, naturalKey) {
    ...
    async lookupDimensionKey(tableName, naturalKeyColumn, naturalKeyValue) {
        try {
    ...
    async lookupFactKey(tableName, naturalKeyColumn, naturalKeyValue) {
        try {
    ...
    async handleSlowlyChangingDimension(tableName, newData, naturalKeyColumn) {
    ...
    hasRecordChanged(existing, newRecord) {
    ...
    calculateAvgDuration(sessions, treatmentType) {
    ...
    calculateAvgEffectiveness(sessions, treatmentType) {
        const filteredSessions = sessions.filter(s => s.treatment_type === treatmentType);
        if (filteredSessions.length === 0)
            return 0;
    ...
    async bulkLoad(config, dataSets) {
        const results = [];
