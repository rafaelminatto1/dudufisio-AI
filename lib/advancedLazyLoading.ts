...
export const createSmartLazyComponent = <T extends ComponentType<any>>(
  ...
  const SmartLazyWrapper: React.FC<any> = (props) => {
...
export const HeavyComponents = {
  ...
  ExerciseFormModal: createSmartLazyComponent(
    () => import('../components/ExerciseFormModal'),
    { priority: 'medium', chunkName: 'exercise-form' }
  ),

  WhatsappChatInterface: createSmartLazyComponent(
    () => import('../components/whatsapp/WhatsappChatInterface'),
    { priority: 'low', chunkName: 'whatsapp-chat' }
  ),

  // Componentes de relatórios
  ReportsDashboard: createSmartLazyComponent(
    () => import('../components/reports/ReportsDashboard'),
    { priority: 'low', chunkName: 'reports' }
  ),

  // Componentes de comunicação
  CommunicationDashboard: createSmartLazyComponent(
    () => import('../components/communication/CommunicationDashboard'),
    { priority: 'medium', chunkName: 'communication' }
  ),

  // Componentes financeiros
  FinancialDashboard: createSmartLazyComponent(
    () => import('../components/financial/FinancialDashboard'),
    { priority: 'low', chunkName: 'financial' }
  ),

  // Componentes de prontuários
  MedicalRecordsDashboard: createSmartLazyComponent(
    () => import('../components/medical-records/MedicalRecordsDashboard'),
    { priority: 'medium', chunkName: 'medical-records' }
  ),

  // Componentes de suprimentos
  SuppliesDashboard: createSmartLazyComponent(
    () => import('../components/supplies/SuppliesDashboard'),
    { priority: 'low', chunkName: 'supplies' }
  ),

  // Componentes de eventos
  EventFormModal: createSmartLazyComponent(
    () => import('../components/events/EventFormModal'),
    { priority: 'medium', chunkName: 'event-form' }
  ),

  EventDetailHeader: createSmartLazyComponent(
    () => import('../components/events/EventDetailHeader'),
    { priority: 'medium', chunkName: 'event-detail' }
  ),

  // Componentes de usuários
  UserFormModal: createSmartLazyComponent(
    () => import('../components/users/UserFormModal'),
    { priority: 'medium', chunkName: 'user-form' }
  ),

  // Componentes de pacientes
  PatientForm: createSmartLazyComponent(
    () => import('../components/pacientes/PatientForm'),
    { priority: 'medium', chunkName: 'patient-form' }
  ),

  // Componentes de sessões
  SessionForm: createSmartLazyComponent(
    () => import('../components/session/SessionForm'),
    { priority: 'medium', chunkName: 'session-form' }
  ),

  // Componentes de teleconsulta
  ExerciseSharePanel: createSmartLazyComponent(
    () => import('../components/teleconsulta/ExerciseSharePanel'),
    { priority: 'low', chunkName: 'exercise-share' }
  ),

  // Componentes de notificações
  NotificationSettings: createSmartLazyComponent(
    () => import('../components/notifications/NotificationSettings'),
    { priority: 'low', chunkName: 'notification-settings' }
  ),

  // Componentes de alertas
  AlertSettings: createSmartLazyComponent(
    () => import('../components/alerts/NotificationSettings'),
    { priority: 'low', chunkName: 'alert-settings' }
  ),

  // Componentes de mentoria
  CasesList: createSmartLazyComponent(
    () => import('../components/mentoria/CasesList'),
    { priority: 'low', chunkName: 'cases-list' }
  ),

  InternsTable: createSmartLazyComponent(
    () => import('../components/mentoria/InternsTable'),
    { priority: 'low', chunkName: 'interns-table' }
  ),

  // Componentes de portal do paciente
  PatientDashboard: createSmartLazyComponent(
    () => import('../components/patient-portal/PatientDashboard'),
    { priority: 'medium', chunkName: 'patient-dashboard' }
  ),

  // Componentes de UI
  VirtualizedList: createSmartLazyComponent(
    () => import('../components/ui/VirtualizedList'),
    { priority: 'medium', chunkName: 'virtualized-list' }
  )
};
...
export const SmartFallback: React.FC<{ 
...
}> = ({ componentName, connectionSpeed = 'unknown' }) => {
  const messages = {
  ...
  const message = messages[componentName as keyof typeof messages] || 'Carregando...';
