...
export const useKeyboardNavigation = (options = {}) => {
    const { onEnter, onEscape, onArrowUp, onArrowDown, onArrowLeft, onArrowRight, onSpace, onTab, onShiftTab, enabled = true } = options;
...
export const useListNavigation = (items, initialIndex = 0, options = {}) => {
...
export const useModalKeyboardNavigation = (onClose) => {
    useKeyboardNavigation({
        onEscape: onClose,
        enabled: true
    });
