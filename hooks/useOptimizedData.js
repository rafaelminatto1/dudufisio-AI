...
export function useOptimizedData(key, fetchFn, options = {}) {
    const { ttl = 5 * 60 * 1000, // 5 minutos por padrão
    ...
    const isDataFresh = useCallback((entry) => {
 ...
 */
export function useOptimizedTherapists(options = {}) {
    return useOptimizedData('therapists', async () => {
 ...
 */
export function useOptimizedPatients(options = {}) {
    return useOptimizedData('patients', async () => {
...
export function useOptimizedAppointments(options = {}) {
    return useOptimizedData('appointments', async () => {
 ...
 */
export function useOptimizedCombinedData(options = {}) {
