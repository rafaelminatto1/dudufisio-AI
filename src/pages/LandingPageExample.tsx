...
/**
 * Landing Page Example - Monday.com Inspired
 *
 * Exemplo de landing page moderna usando o novo design system
 */
      ...
      <Section variant="white" paddingY="5xl">
        <div className="text-center space-y-xl max-w-4xl mx-auto">
          <div className="space-y-md">
            <Caption className="uppercase tracking-wider">MoocaFisio 2025</Caption>
        ...
        <div className="space-y-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-lg">
            ...
            <FeatureCard
              ...
              description="Seus dados protegidos conforme LGPD"
              icon={Shield}
              variant="accent-pink"
              features={[
