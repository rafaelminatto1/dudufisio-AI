 ...
 */
export const SafeAvatar = ({ src, alt, fallbackId, className = '', size = 'md' }) => {
    ...
    return (<img src={safeSrc} alt={alt} className={`rounded-full object-cover ${sizeClasses[size]} ${className}`} onError={(e) => {
