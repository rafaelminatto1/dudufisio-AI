...
const PlanCard = ({ plan }) => {
    return (<div className={`rounded-2xl border-2 p-6 flex flex-col h-full transition-all duration-300 ${plan.popular ? 'border-sky-500 shadow-lg bg-white' : 'border-slate-200 bg-white'}`}>
            ...
            <button className={`w-full py-3 px-6 rounded-lg font-semibold text-center transition-colors ${plan.popular ? 'bg-sky-500 text-white hover:bg-sky-600' : 'bg-slate-100 text-slate-700 hover:bg-slate-200'}`}>
