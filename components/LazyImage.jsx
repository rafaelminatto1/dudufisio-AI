...
export const LazyImage = ({ src, alt, className, placeholder = 'data:image/svg+xml;base64,', fallback = 'data:image/svg+xml;base64,', onLoad, onError, threshold = 0.1, rootMargin = '50px' }) => {
    ...
    return (<div ref={imgRef} className={cn('relative overflow-hidden', className)}>
      <img src={imageSrc} alt={alt} onLoad={handleLoad} onError={handleError} className={cn('transition-opacity duration-300', isLoaded && !hasError ? 'opacity-100' : 'opacity-70')} loading="lazy"/>
      
      {!isLoaded && !hasError && isInView && (<div className="absolute inset-0 flex items-center justify-center bg-gray-100">
