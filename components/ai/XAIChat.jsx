...
export const XAIChat = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const result = await xaiService.generateText(input, 'Você é um assistente de fisioterapia especializado. Responda de forma clara, profissional e em português brasileiro.');
            setResponse(result);
        }
        catch (error) {
