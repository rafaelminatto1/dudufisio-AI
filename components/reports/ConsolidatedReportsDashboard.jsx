...
import { Download, Filter, Calendar, TrendingUp, Users, DollarSign, Activity, FileText, BarChart3, PieChart as PieChartIcon } from 'lucide-react';
...
const ConsolidatedReportsDashboard = () => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <PieChart>
                    <Pie data={aiData} cx="50%" cy="50%" innerRadius={60} outerRadius={100} dataKey="value">
                      {aiData.map((entry, index) => (<Cell key={`cell-${index}`} fill={entry.color}/>))}
                    </Pie>
                    <Tooltip />
                  </PieChart>
                </ResponsiveContainer>
