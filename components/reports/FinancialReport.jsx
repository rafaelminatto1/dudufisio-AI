...
const FinancialReport = ({ appointments, therapists }) => {
    ...
    return (<div className="space-y-6 animate-fade-in-fast">
                    ...
                    <div className="h-72">
                        <ResponsiveContainer width="100%" height="100%">
                            <LineChart data={revenueByDay} margin={{ top: 5, right: 20, left: -10, bottom: 5 }}>
                                ...
                                <YAxis stroke="#64748b" fontSize={12} tickFormatter={(val) => formatCurrency(val)}/>
                                <Tooltip formatter={(val) => [formatCurrency(val), "Faturamento"]}/>
                 ...
                 <div className="overflow-x-auto">
                    <table className="min-w-full">
                        ...
                        <tbody className="divide-y divide-slate-200">
                            {appointments.filter(a => a.status === 'Realizado').slice(0, 10).map(app => (<tr key={app.id}>
