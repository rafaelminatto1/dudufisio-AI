...
const ObservationModal = ({ isOpen, onClose, onSave, patient }) => {
    ...
    return (<div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4" onClick={onClose}>
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg" onClick={e => e.stopPropagation()}>
                ...
                <main className="p-6">
                    <textarea value={notes} onChange={(e) => setNotes(e.target.value)} rows={5} className="w-full p-2 border border-slate-300 rounded-lg" placeholder="Ex: Tentei contato por telefone, sem sucesso. Deixei recado na caixa postal." autoFocus/>
                </main>
