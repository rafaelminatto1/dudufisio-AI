...
const AlertCard = ({ patient, onOpenObservationModal, onOpenRescheduleModal, onOpenAiSuggestion, onUpdate }) => {
    ...
    const handleLogContact = async (contactType) => {
        if (!user)
            return;
        try {
    ...
    return (<div className={`bg-white rounded-2xl shadow-sm border-t-4 ${currentTypeInfo.borderColor} overflow-hidden flex flex-col h-full`}>
