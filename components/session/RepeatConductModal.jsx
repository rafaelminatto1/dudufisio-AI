...
const RepeatConductModal = ({ isOpen, onClose, onConfirm, previousNote, patientName }) => {
    ...
    const CopyButton = ({ field, label }) => (<button type="button" onClick={() => handleCopyField(field)} className={`flex items-center px-3 py-1 text-xs rounded-lg transition-colors ${copiedFields.has(field)
    ...
    return (<div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              ...
              <RichTextEditor value={conductData.subjective} onChange={(value) => handleFieldChange('subjective', value)} placeholder="Descreva as queixas e relatos do paciente..."/>
            </div>
            ...
            <div className="space-y-3">
              ...
              <RichTextEditor value={conductData.objective} onChange={(value) => handleFieldChange('objective', value)} placeholder="Descreva os achados objetivos da avaliação..."/>
            </div>
            ...
            <div className="space-y-3">
              ...
              <RichTextEditor value={conductData.assessment} onChange={(value) => handleFieldChange('assessment', value)} placeholder="Descreva sua avaliação clínica..."/>
            </div>
            ...
            <div className="space-y-3">
              ...
              <RichTextEditor value={conductData.plan} onChange={(value) => handleFieldChange('plan', value)} placeholder="Descreva o plano de tratamento..."/>
            </div>
          </div>
        ...
        <footer className="flex items-center justify-end space-x-3 p-6 border-t">
          ...
          <button onClick={handleConfirm} className="flex items-center px-6 py-2 text-sm bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors">
