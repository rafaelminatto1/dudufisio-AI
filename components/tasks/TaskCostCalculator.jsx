...
import { useTaskCost } from '../../hooks/useTaskSupplies';
import { DollarSign, Calculator, TrendingUp, Package } from 'lucide-react';
const TaskCostCalculator = ({ taskId, taskSupplies = [], showDetails = true, compact = false }) => {
    ...
    if (compact) {
        return (<div className="inline-flex items-center px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm font-medium">
    ...
    if (error) {
        return (<div className="bg-red-50 border border-red-200 rounded-lg p-3">
    ...
    return (<div className="bg-white border border-gray-200 rounded-lg p-4">
      <div className="flex items-center justify-between mb-4">
        ...
        <button onClick={handleRecalculate} disabled={isCalculating} className="inline-flex items-center px-3 py-1 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 disabled:opacity-50 text-sm">
          {isCalculating ? (<>
      ...
      <div className="space-y-3">
        ...
        {laborCost > 0 && (<div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
            <div className="flex items-center">
        ...
        {/* Custos Indiretos */}
        {overheadCost > 0 && (<div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
            <div className="flex items-center">
      ...
      {showDetails && taskSupplies.length > 0 && (<div className="mt-6">
          <h4 className="text-sm font-medium text-gray-700 mb-3">Detalhamento dos Insumos</h4>
          <div className="space-y-2">
            {taskSupplies.map((supply) => (<div key={supply.id} className="flex items-center justify-between py-2 px-3 bg-gray-50 rounded-lg">
      ...
      {taskCost && (<div className="mt-4 pt-4 border-t border-gray-200">
      ...
      {supplyCost > 0 && (<div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg">
          <div className="flex items-center">
          ...
          {taskSupplies.length > 0 && (<p className="text-xs text-green-600 mt-1">
