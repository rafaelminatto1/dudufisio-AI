...
export const RoleGuard = ({ allowedRoles, children, fallback }) => {
    ...
    if (!hasPermission) {
        return fallback || (<div className="flex flex-col items-center justify-center min-h-[400px] p-8">
...
export const DataFilter = ({ userRole, userId, patientId, children, data, filterType }) => {
