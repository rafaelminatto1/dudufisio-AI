...
const SellVoucherCard = ({ patients, partners, plans, onSell }) => {
    ...
    return (<div className="bg-white p-6 rounded-2xl shadow-sm">
            ...
            <div className="space-y-4">
                <div>
                 ...
                 <button onClick={handleSubmit} disabled={isSelling} className="w-full inline-flex items-center justify-center bg-teal-500 hover:bg-teal-600 text-white font-bold py-3 px-4 rounded-lg shadow-sm transition-colors disabled:bg-teal-300">
