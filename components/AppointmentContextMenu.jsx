...
const AppointmentContextMenu = ({ x, y, onClose, onSetStatus, onSetPayment, onEdit, onDelete }) => {
    ...
    return (<div ref={menuRef} style={{ top: y, left: x }} className="absolute z-30 w-56 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none animate-fade-in-fast">
