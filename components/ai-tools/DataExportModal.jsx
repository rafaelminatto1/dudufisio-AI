...
import { Download, FileText, Calendar, Users, Brain, BarChart3, Database, Loader2, CheckCircle, AlertCircle, Settings, Archive } from 'lucide-react';
...
const DataExportModal = ({ isOpen, onClose }) => {
    ...
    const generateMockData = (dataType, count) => {
        const baseData = {
            id: '',
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            return (<div key={type.key} className="flex items-center space-x-3 p-3 border rounded-lg hover:bg-gray-50 transition-colors">
                      <Checkbox id={type.key} checked={selectedData[type.key]} onCheckedChange={() => handleDataToggle(type.key)}/>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={exportOptions.dateRange} onValueChange={(value) => handleOptionChange('dateRange', value)}>
                    <SelectTrigger>
              ...
              {exportOptions.dateRange === 'custom' && (<div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="startDate">Data Inicial</Label>
                    <Input id="startDate" type="date" value={exportOptions.customStart || ''} onChange={(e) => handleOptionChange('customStart', e.target.value)}/>
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="endDate">Data Final</Label>
                    <Input id="endDate" type="date" value={exportOptions.customEnd || ''} onChange={(e) => handleOptionChange('customEnd', e.target.value)}/>
                  </div>
                </div>)}

              <div className="flex items-center space-x-2">
                <Checkbox id="includeMetadata" checked={exportOptions.includeMetadata} onCheckedChange={(checked) => handleOptionChange('includeMetadata', checked)}/>
              ...
              <div className="flex items-center space-x-2">
                <Checkbox id="compressFiles" checked={exportOptions.compressFiles} onCheckedChange={(checked) => handleOptionChange('compressFiles', checked)}/>
              ...
              <CardContent className="pt-6">
                <div className="space-y-4">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div className="bg-blue-600 h-2 rounded-full transition-all duration-300" data-width={exportProgress}></div>
                  </div>
          ...
          <div className="flex justify-end gap-2 pt-4">
            ...
            <Button onClick={exportData} disabled={!someSelected || isExporting} className="flex items-center gap-2">
