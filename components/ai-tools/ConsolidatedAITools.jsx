...
import { FilePlus, FileClock, Dumbbell, AlertTriangle, BrainCircuit, MessageSquare, AreaChart, Download, Play, Settings, Zap, CheckCircle, Clock, BarChart3, TrendingUp, Users, DollarSign } from 'lucide-react';
    ...
    return (<div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <Button variant="outline" size="sm" onClick={() => setActiveModals(prev => ({ ...prev, settings: true }))}>
            <Settings className="w-4 h-4 mr-2"/>
            Configurações
          </Button>
          <Button size="sm" onClick={() => setActiveModals(prev => ({ ...prev, export: true }))}>
      ...
      <Tabs defaultValue="tools" className="w-full">
            ...
            <Card className="lg:col-span-2">
              ...
              <CardContent>
                <div className="space-y-4">
                  {aiUsageData.map((tool, index) => (<div key={index} className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg hover:shadow-md transition-shadow">
        ...
        <TabsContent value="activity" className="space-y-6">
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {recentActivities.map((activity) => (<div key={activity.id} className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="flex items-center gap-3">
      ...
      <GenerateReportModal isOpen={activeModals.generateReport} onClose={() => closeModal('generateReport')} patientData={{
            id: '1',
            name: 'João Silva',
            age: 45,
            diagnosis: 'Lombalgia',
      ...
      <GenerateEvolutionModal isOpen={activeModals.generateEvolution} onClose={() => closeModal('generateEvolution')} patientData={{
            id: '2',
            name: 'Maria Santos',
            age: 38,
      ...
      <GenerateHEPModal isOpen={activeModals.generateHEP} onClose={() => closeModal('generateHEP')} patientData={{
            id: '3',
            name: 'Pedro Costa',
            age: 52,
      ...
      <RiskAnalysisModal isOpen={activeModals.riskAnalysis} onClose={() => closeModal('riskAnalysis')} patientData={{
            id: '4',
            name: 'Ana Oliveira',
            age: 29,
            diagnosis: 'Tendinite',
      ...
      <AIChatModal isOpen={activeModals.aiChat} onClose={() => closeModal('aiChat')}/>

      <EconomicAIModal isOpen={activeModals.economicAI} onClose={() => closeModal('economicAI')}/>

      <AISettingsModal isOpen={activeModals.settings} onClose={() => closeModal('settings')}/>

      <DataExportModal isOpen={activeModals.export} onClose={() => closeModal('export')}/>
    </div>);
};
