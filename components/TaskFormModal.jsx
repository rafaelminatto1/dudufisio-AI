...
const getInitialFormData = (therapists, projectId) => ({
    projectId,
    title: '',
    description: '',
...
const TaskFormModal = ({ isOpen, onClose, onSave, taskToEdit, therapists, projectId }) => {
    ...
    const handleSaveClick = async () => {
        setIsSaving(true);
        const { actorUserId, ...saveData } = formData;
