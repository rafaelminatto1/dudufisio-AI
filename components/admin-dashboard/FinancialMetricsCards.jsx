...
const FinancialMetricsCards = ({ data, isLoading = false }) => {
    if (isLoading) {
    ...
    return (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      <Card className="hover:shadow-md transition-shadow">
        ...
        <CardContent>
          ...
          <div className="flex items-center text-sm">
            {data.revenueGrowth >= 0 ? (<TrendingUp className="w-4 h-4 mr-1 text-green-600"/>) : (<TrendingDown className="w-4 h-4 mr-1 text-red-600"/>)}
      ...
      <Card className="hover:shadow-md transition-shadow">
        ...
        <CardContent>
          ...
          <div className="flex items-center text-sm">
            {data.ticketGrowth >= 0 ? (<TrendingUp className="w-4 h-4 mr-1 text-green-600"/>) : (<TrendingDown className="w-4 h-4 mr-1 text-red-600"/>)}
      ...
      <Card className="hover:shadow-md transition-shadow">
        ...
        <CardContent>
          ...
          <div className="mt-2 w-full bg-gray-200 rounded-full h-2">
            <div className="bg-purple-600 h-2 rounded-full transition-all duration-500" style={{ width: `${data.occupancyRate}%` }}></div>
          </div>
        </CardContent>
      </Card>
