...
const OperationalMetricsCards = ({ data, isLoading = false }) => {
      ...
      <Card className="hover:shadow-md transition-shadow">
        ...
        <CardContent>
          ...
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div className="bg-green-600 h-2 rounded-full transition-all duration-500" style={{ width: `${activePercentage}%` }}></div>
          </div>
        </CardContent>
      </Card>
