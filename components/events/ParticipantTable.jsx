...
const ParticipantTable = ({ registrations, onCheckIn }) => {
    ...
    return (<div>
            <div className="relative mb-4 max-w-sm">
                ...
                <input type="text" value={searchTerm} onChange={e => setSearchTerm(e.target.value)} placeholder="Buscar participante..." className="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-lg"/>
            </div>
             <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-slate-200">
                    ...
                    <tbody className="bg-white divide-y divide-slate-200">
                        {filteredRegistrations.map(reg => (<tr key={reg.id}>
                                ...
                                <td className="p-3 text-center">
                                 ...
                                 <td className="p-3 text-center">
                                    {reg.status === RegistrationStatus.Confirmed && (<button onClick={() => onCheckIn(reg.id)} className="p-1.5 text-green-600 bg-green-50 hover:bg-green-100 rounded-full" title="Realizar Check-in">
