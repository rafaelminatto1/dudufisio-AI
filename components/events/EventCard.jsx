...
const EventCard = ({ event, onEdit }) => {
    ...
    return (<div onClick={handleCardClick} className="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-shadow duration-300 flex flex-col group overflow-hidden cursor-pointer">
            {/* Image and Status */}
            ...
            <div className="p-4 flex flex-col flex-grow">
                ...
                <div className="mt-4">
                    ...
                    {event.capacity && (<div className="w-full bg-slate-200 rounded-full h-2">
