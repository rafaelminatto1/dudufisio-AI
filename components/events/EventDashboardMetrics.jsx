...
const EventDashboardMetrics = ({ event, registrations }) => {
    ...
    if (checkInRate < 75)
        checkInColor = 'bg-amber-500';
    if (checkInRate < 50)
        checkInColor = 'bg-red-500';
    return (<div className="bg-slate-50 p-6 rounded-2xl border border-slate-200">
