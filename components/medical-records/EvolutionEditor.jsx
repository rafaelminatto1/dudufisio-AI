...
import { AlertCircle, CheckCircle, Save, Send, Activity, Target, Calendar, User, Heart, Clock, Plus, Trash2, TrendingUp, TrendingDown, MapPin,
...
export function EvolutionEditor({ patientId, sessionId, onSave, onSaveDraft, onCancel, initialData, isLoading = false, previousEvolution }) {
    ...
    useEffect(() => {
        ...
        const filledFields = Object.values(watchedValues).filter(value => value !== undefined && value !== null && value !== '').length;
    ...
    const removeHomeExercise = (index) => {
        const currentHomeExercises = form.getValues('homeExercises') || [];
    ...
    return (<div className="max-w-6xl mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Button variant="outline" size="sm" onClick={() => setShowBodyMap(!showBodyMap)} className="flex items-center space-x-2">
      ...
      {watchedValues.painLevelBefore > 0 && (<Card>
          <CardHeader>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center">
                <div className={`text-2xl font-bold flex items-center justify-center space-x-1 ${painImprovement > 0 ? 'text-green-600' :
        ...
        <form onSubmit={form.handleSubmit(handleSave)} className="space-y-6">
          <Tabs value={currentTab} onValueChange={setCurrentTab} className="w-full">
            <TabsList className="grid w-full grid-cols-5">
              {tabs.map((tab) => {
            const Icon = tab.icon;
            return (<TabsTrigger key={tab.id} value={tab.id} className="flex items-center space-x-2">
            ...
            <TabsContent value="subjective" className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-4">
                  <FormField control={form.control} name="subjectiveAssessment" render={({ field }) => (<FormItem>
                        <FormLabel>Relato do Paciente</FormLabel>
                        <FormControl>
                          <Textarea placeholder="Descreva como o paciente se sente, queixas, melhorias, pioras..." className="min-h-[120px]" {...field}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>)}/>

                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField control={form.control} name="painLevelBefore" render={({ field }) => (<FormItem>
                          <FormLabel>Nível de Dor - Antes (0-10)</FormLabel>
                          <FormControl>
                            <div className="space-y-2">
                              <Slider value={[field.value]} onValueChange={(value) => field.onChange(value[0])} max={10} min={0} step={1} className="w-full"/>
                    ...
                    <FormField control={form.control} name="painLevelAfter" render={({ field }) => (<FormItem>
            ...
            <TabsContent value="objective" className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-4">
                  <FormField control={form.control} name="objectiveFindings" render={({ field }) => (<FormItem>
                        <FormLabel>Achados Objetivos</FormLabel>
                        <FormControl>
                          <Textarea placeholder="Descreva os achados da avaliação física, testes, medidas..." className="min-h-[120px]" {...field}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>)}/>
                  ...
                  <div>
                    ...
                    <Textarea placeholder="Ex: Amplitude de movimento, força muscular, testes especiais..." className="min-h-[80px]"/>
                  </div>
                </CardContent>
              </Card>
            </TabsContent>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <Button type="button" variant="outline" size="sm" onClick={addTechnique} className="flex items-center space-x-2">
                    ...
                    <div className="space-y-4">
                      {watchedValues.techniquesApplied?.map((technique, index) => (<Card key={index}>
                          <CardContent className="pt-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <FormField control={form.control} name={`techniquesApplied.${index}.name`} render={({ field }) => (<FormItem>
                              ...
                              <FormField control={form.control} name={`techniquesApplied.${index}.duration`} render={({ field }) => (<FormItem>
                              ...
                              <FormField control={form.control} name={`techniquesApplied.${index}.response`} render={({ field }) => (<FormItem className="md:col-span-2">
                                    <FormLabel>Resposta</FormLabel>
                                    <FormControl>
                                      <Textarea placeholder="Como o paciente respondeu à técnica..." className="min-h-[60px]" {...field}/>
                                    </FormControl>
                                    <FormMessage />
                                  </FormItem>)}/>
                            </div>
                            ...
                            <div className="flex justify-end mt-4">
                              <Button type="button" variant="outline" size="sm" onClick={() => removeTechnique(index)} className="text-red-600 hover:text-red-700">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <Button type="button" variant="outline" size="sm" onClick={addExercise} className="flex items-center space-x-2">
                        <Plus className="h-4 w-4"/>
                    ...
                    <div className="space-y-4">
                      {watchedValues.exercisesPerformed?.map((exercise, index) => (<Card key={index}>
                          <CardContent className="pt-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <FormField control={form.control} name={`exercisesPerformed.${index}.name`} render={({ field }) => (<FormItem>
                              ...
                              <FormField control={form.control} name={`exercisesPerformed.${index}.repetitions`} render={({ field }) => (<FormItem>
                              ...
                              <FormField control={form.control} name={`exercisesPerformed.${index}.sets`} render={({ field }) => (<FormItem>
                              ...
                              <FormField control={form.control} name={`exercisesPerformed.${index}.instructions`} render={({ field }) => (<FormItem className="md:col-span-2">
                                    <FormLabel>Instruções</FormLabel>
                                    <FormControl>
                                      <Textarea placeholder="Instruções específicas do exercício..." className="min-h-[60px]" {...field}/>
                                    </FormControl>
                                    <FormMessage />
                                  </FormItem>)}/>
                            </div>
                            ...
                            <div className="flex justify-end mt-4">
                              <Button type="button" variant="outline" size="sm" onClick={() => removeExercise(index)} className="text-red-600 hover:text-red-700">
                                <Trash2 className="h-4 w-4 mr-1"/>
                                Remover
                              </Button>
                            </div>
            ...
            <TabsContent value="response" className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-4">
                  <FormField control={form.control} name="patientResponse" render={({ field }) => (<FormItem>
                        <FormLabel>Resposta do Paciente</FormLabel>
                        <FormControl>
                          <Textarea placeholder="Descreva como o paciente respondeu ao tratamento..." className="min-h-[120px]" {...field}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>)}/>

                  <FormField control={form.control} name="adverseReactions" render={({ field }) => (<FormItem>
                        <FormLabel>Reações Adversas (se houver)</FormLabel>
                        <FormControl>
                          <Textarea placeholder="Descreva qualquer reação adversa ou efeito colateral..." className="min-h-[80px]" {...field}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>)}/>
                </CardContent>
            ...
            <TabsContent value="planning" className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-6">
                  <FormField control={form.control} name="nextSessionPlan" render={({ field }) => (<FormItem>
                        <FormLabel>Plano para Próxima Sessão</FormLabel>
                        <FormControl>
                          <Textarea placeholder="Descreva o que será feito na próxima sessão..." className="min-h-[100px]" {...field}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>)}/>

                  <FormField control={form.control} name="recommendations" render={({ field }) => (<FormItem>
                        <FormLabel>Recomendações</FormLabel>
                        <FormControl>
                          <Textarea placeholder="Recomendações gerais para o paciente..." className="min-h-[80px]" {...field}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>)}/>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <Button type="button" variant="outline" size="sm" onClick={addHomeExercise} className="flex items-center space-x-2">
                        <Plus className="h-4 w-4"/>
                        <span>Adicionar Exercício</span>
                      </Button>
                    </div>
                    ...
                    <div className="space-y-4">
                      {watchedValues.homeExercises?.map((exercise, index) => (<Card key={index}>
                          <CardContent className="pt-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <FormField control={form.control} name={`homeExercises.${index}.name`} render={({ field }) => (<FormItem>
                                    <FormLabel>Nome do Exercício</FormLabel>
                                    <FormControl>
                              ...
                              <FormField control={form.control} name={`homeExercises.${index}.repetitions`} render={({ field }) => (<FormItem>
                                    <FormLabel>Repetições</FormLabel>
                                    <FormControl>
                                      <Input type="number" min="1" {...field} onChange={(e) => field.onChange(parseInt(e.target.value))}/>
                                    </FormControl>
                              ...
                              <FormField control={form.control} name={`homeExercises.${index}.sets`} render={({ field }) => (<FormItem>
                                    <FormLabel>Séries</FormLabel>
                                    <FormControl>
                                      <Input type="number" min="1" {...field} onChange={(e) => field.onChange(parseInt(e.target.value))}/>
                                    </FormControl>
                              ...
                              <FormField control={form.control} name={`homeExercises.${index}.instructions`} render={({ field }) => (<FormItem className="md:col-span-2">
                                    <FormLabel>Instruções</FormLabel>
                                    <FormControl>
                                      <Textarea placeholder="Instruções detalhadas para o paciente..." className="min-h-[60px]" {...field}/>
                                    </FormControl>
                                    <FormMessage />
                                  </FormItem>)}/>
                            </div>
                            ...
                            <div className="flex justify-end mt-4">
                              <Button type="button" variant="outline" size="sm" onClick={() => removeHomeExercise(index)} className="text-red-600 hover:text-red-700">
                                <Trash2 className="h-4 w-4 mr-1"/>
                                Remover
                              </Button>
                            </div>
          ...
          <div className="flex justify-between items-center pt-6 border-t">
            ...
            <div className="flex space-x-3">
              <Button type="button" variant="secondary" onClick={handleSaveDraft} disabled={isLoading} className="flex items-center space-x-2">
                <Save className="h-4 w-4"/>
                <span>Salvar Rascunho</span>
              </Button>

              <Button type="submit" disabled={!isValid || isLoading} className="flex items-center space-x-2">
                {isLoading ? (<>
