...
import { FileText, Settings, Shield, BarChart3, User, Database, CheckCircle, Clock, AlertTriangle } from 'lucide-react';
      ...
      <div className="container mx-auto p-6">
        ...
        <Tabs value={activeModule} onValueChange={setActiveModule} className="w-full">
          <TabsList className="grid w-full grid-cols-4 mb-6">
            {modules.map((module) => (<TabsTrigger key={module.id} value={module.id} className="flex items-center gap-2">
                {module.icon}
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <Button variant="outline" className="h-20 flex flex-col items-center justify-center" onClick={() => setActiveModule('dashboard')}>
                  <FileText className="h-6 w-6 mb-2"/>
                  <span className="text-sm">Novo Prontuário</span>
                </Button>
                
                <Button variant="outline" className="h-20 flex flex-col items-center justify-center" onClick={() => setActiveModule('templates')}>
                  <Settings className="h-6 w-6 mb-2"/>
                  <span className="text-sm">Criar Template</span>
                </Button>
                
                <Button variant="outline" className="h-20 flex flex-col items-center justify-center" onClick={() => setActiveModule('signatures')}>
                  <Shield className="h-6 w-6 mb-2"/>
                  <span className="text-sm">Assinar Documento</span>
                </Button>
                
                <Button variant="outline" className="h-20 flex flex-col items-center justify-center" onClick={() => setActiveModule('reports')}>
