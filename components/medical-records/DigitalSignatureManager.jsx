...
import { Shield, FileText, CheckCircle, XCircle, Clock, Download, Upload, 
// Certificate, // Substituído por MdCertificate do react-icons
AlertTriangle, Eye, RefreshCw, X } from 'lucide-react';
...
export function DigitalSignatureManager() {
    ...
    const handleSignDocument = async (documentId, certificateId) => {
        setIsSigning(true);
        try {
            ...
            setDocuments(documents.map(doc => doc.id === documentId
                ? { ...doc, isSigned: true, signedBy: 'Current User', signedAt: new Date(), status: 'signed' }
                : doc));
            toast({
    ...
    const handleVerifySignature = async (signatureId) => {
        ...
        try {
            ...
            setSignatures(signatures.map(sig => sig.id === signatureId
    ...
    return (<div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto p-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="certificates" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {certificates.map((certificate) => (<Card key={certificate.id} className="hover:shadow-lg transition-shadow">
                  <CardHeader>
          ...
          <TabsContent value="documents" className="space-y-6">
            ...
            <div className="space-y-4">
              {documents.map((document) => (<Card key={document.id} className="hover:shadow-lg transition-shadow">
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          {document.isSigned && (<Badge variant="outline" className="text-green-600">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm text-gray-600">
                          ...
                          <div>
                            ...
                            {document.signedAt && (<p><strong>Assinado em:</strong> {document.signedAt.toLocaleDateString('pt-BR')}</p>)}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-2">
                        ...
                        {!document.isSigned && (<Select onValueChange={(certId) => handleSignDocument(document.id, certId)}>
                            <SelectTrigger className="w-48">
                              <SelectValue placeholder="Assinar com..."/>
                            </SelectTrigger>
                            <SelectContent>
                              {certificates.filter(cert => isCertificateValid(cert)).map((cert) => (<SelectItem key={cert.id} value={cert.id}>
          ...
          <TabsContent value="signatures" className="space-y-6">
            ...
            <div className="space-y-4">
              {signatures.map((signature) => (<Card key={signature.id} className="hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                      ...
                      <div className="flex gap-2">
                        <Button variant="outline" size="sm" onClick={() => handleVerifySignature(signature.id)} disabled={isVerifying}>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Textarea id="signatureData" placeholder="Cole aqui os dados da assinatura digital para verificação..." rows={6}/>
                </div>
                
                <div>
                  <Label htmlFor="documentHash">Hash do Documento</Label>
                  <Input id="documentHash" placeholder="Hash SHA-256 do documento original"/>
                </div>
        ...
        {selectedDocument && (<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        {selectedDocument.signedAt && (<p><strong>Assinado em:</strong> {selectedDocument.signedAt.toLocaleDateString('pt-BR')}</p>)}
                      </div>
                    </div>
