...
import { Plus, Edit, Trash2, Copy, Eye, Save, X, Settings, Code } from 'lucide-react';
...
export function ClinicalTemplatesManager() {
    ...
    return (<div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto p-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="list" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {templates.map((template) => (<Card key={template.id} className="hover:shadow-lg transition-shadow">
                  <CardHeader>
          ...
          <TabsContent value="form" className="space-y-6">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="name" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} placeholder="Ex: Avaliação Inicial - Fisioterapia"/>
                  </div>
                  <div>
                    ...
                    <Select value={formData.type} onValueChange={(value) => setFormData({ ...formData, type: value })}>
                      ...
                      <SelectContent>
                        {DOCUMENT_TYPES.map((type) => (<SelectItem key={type.value} value={type.value}>
                            {type.label}
                          </SelectItem>))}
                      </SelectContent>
                    </Select>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Textarea id="templateSchema" value={formData.templateSchema} onChange={(e) => setFormData({ ...formData, templateSchema: e.target.value })} placeholder='{"type": "object", "properties": {...}}' rows={10} className="font-mono text-sm"/>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Textarea id="defaultValues" value={formData.defaultValues} onChange={(e) => setFormData({ ...formData, defaultValues: e.target.value })} placeholder='{"painLevel": 0, "status": "active"}' rows={6} className="font-mono text-sm"/>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Textarea id="validationRules" value={formData.validationRules} onChange={(e) => setFormData({ ...formData, validationRules: e.target.value })} placeholder='{"painLevel": {"min": 0, "max": 10}}' rows={6} className="font-mono text-sm"/>
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
        ...
        {selectedTemplate && !isEditing && (<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
