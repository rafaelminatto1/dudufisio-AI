...
import { AlertCircle, CheckCircle, Save, Send, FileText, Stethoscope, Activity, Target, Calendar, Heart, Brain, Bone, 
// Lungs, // Substituído por MdLungs do react-icons
Baby, Zap, Shield, Clock } from 'lucide-react';
...
export function AssessmentForm({ patientId, specialty, onSave, onSaveDraft, onCancel, initialData, isLoading = false }) {
          ...
          <Tabs value={currentTab} onValueChange={setCurrentTab} className="w-full">
            ...
            <TabsContent value="complaint" className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-4">
                  <FormField control={form.control} name="chiefComplaint.description" render={({ field }) => (<FormItem>
                        <FormLabel>Descrição da Queixa</FormLabel>
                        <FormControl>
                          <Textarea placeholder="Descreva detalhadamente a queixa principal do paciente..." className="min-h-[100px]" {...field}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>)}/>

                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField control={form.control} name="chiefComplaint.onset" render={({ field }) => (<FormItem>
                    ...
                    <FormField control={form.control} name="chiefComplaint.duration" render={({ field }) => (<FormItem>
                          <FormLabel>Duração</FormLabel>
                          <FormControl>
                            <Input placeholder="Ex: 2 semanas, 1 mês, 3 dias" {...field}/>
                          </FormControl>
                          <FormMessage />
                        </FormItem>)}/>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField control={form.control} name="chiefComplaint.characteristics.quality" render={({ field }) => (<FormItem>
                    ...
                    <FormField control={form.control} name="chiefComplaint.characteristics.intensity" render={({ field }) => (<FormItem>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea placeholder="Descreva doenças anteriores, hospitalizações, etc..." className="min-h-[100px]"/>
                  </div>

                  <FormField control={form.control} name="medicalHistory.socialHistory.occupation" render={({ field }) => (<FormItem>
                        <FormLabel>Ocupação</FormLabel>
                        <FormControl>
                          <Input placeholder="Profissão do paciente" {...field}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>)}/>
                </CardContent>
            ...
            <TabsContent value="exam" className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-4">
                  <FormField control={form.control} name="physicalExam.inspection" render={({ field }) => (<FormItem>
                        <FormLabel>Inspeção</FormLabel>
                        <FormControl>
                          <Textarea placeholder="Descreva os achados da inspeção..." className="min-h-[100px]" {...field}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>)}/>

                  <FormField control={form.control} name="physicalExam.palpation" render={({ field }) => (<FormItem>
                        <FormLabel>Palpação</FormLabel>
                        <FormControl>
                          <Textarea placeholder="Descreva os achados da palpação..." className="min-h-[100px]" {...field}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>)}/>
                </CardContent>
            ...
            <TabsContent value="diagnosis" className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-4">
                  <FormField control={form.control} name="diagnosis.primaryDiagnosis" render={({ field }) => (<FormItem>
                        <FormLabel>Diagnóstico Principal</FormLabel>
                        <FormControl>
                          <Textarea placeholder="Descreva o diagnóstico principal..." className="min-h-[100px]" {...field}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>)}/>

                  <FormField control={form.control} name="diagnosis.severity" render={({ field }) => (<FormItem>
            ...
            <TabsContent value="treatment" className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-4">
                  <FormField control={form.control} name="treatmentPlan.frequency" render={({ field }) => (<FormItem>
                        <FormLabel>Frequência</FormLabel>
                        <FormControl>
                          <Input placeholder="Ex: 3x por semana, diário, etc..." {...field}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>)}/>

                  <FormField control={form.control} name="treatmentPlan.duration" render={({ field }) => (<FormItem>
                        <FormLabel>Duração</FormLabel>
                        <FormControl>
                          <Input placeholder="Ex: 6 semanas, 3 meses, etc..." {...field}/>
                        </FormControl>
                        <FormMessage />
                      </FormItem>)}/>
                </CardContent>
