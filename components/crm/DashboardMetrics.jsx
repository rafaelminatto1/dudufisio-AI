...
export const DashboardMetrics = ({ clinicId }) => {
    ...
    if (loading) {
        ...
        {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (<div key={i} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow animate-pulse">
    ...
    if (error) {
        return (<div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg">
    ...
    return (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      {cards.map((card, index) => {
            ...
            return (<div key={index} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition-shadow">
