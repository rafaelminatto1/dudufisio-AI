...
const ClinicalHistoryTimeline = ({ notes, onViewNote }) => {
    return (<div className="bg-white p-6 rounded-2xl shadow-sm">
            <div className="relative border-l-2 border-slate-200 ml-3">
                {notes.length > 0 ? (<ul className="space-y-8">
                        {notes.map(note => (<li key={note.id} className="relative">
                    ...
                    </ul>) : (<div className="pl-8 text-center text-slate-500">
