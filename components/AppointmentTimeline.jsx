...
const AppointmentTimeline = ({ appointments, onAdd }) => {
    ...
    return (<div className="bg-white p-6 rounded-2xl shadow-sm">
            ...
            <div className="relative pl-6">
                ...
                {sortedAppointments.length > 0 ? (<ul className="space-y-6">
                ...
                return (<li key={app.id} className="relative">
                    ...
                    </ul>) : (<div className="text-sm text-slate-500 text-center py-4">Nenhuma consulta encontrada.</div>)}
            </div>
        </div>);
};
