...
import { RiskAssessment, RiskLevel, RiskFactor } from '../../types/riskTypes';
...
export const RiskDetailModal: React.FC<Props> = ({
  ...
  const [activeTab, setActiveTab] = useState<'factors' | 'recommendations' | 'timeline'>('factors');
            ...
            <div className="space-y-4">
              ...
              {assessment.recommendations.map((recommendation, idx) => (
                ...
                >
                  ...
                  {!recommendation.completed && onImplementRecommendation && (
                    <button
