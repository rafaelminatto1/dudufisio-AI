...
import { ChevronLeft, ChevronRight, Calendar as CalendarIcon, Search, Plus, CalendarDays as Today, Clock, Users, DollarSign } from 'lucide-react';
const EnhancedAgendaHeader = ({ currentDate, viewType, onDateChange, onViewChange, onAddAppointment, onSearch, onFilter, appointmentCount = 0, patientCount = 0, totalValue = 0, therapists = [] }) => {
      ...
      <div className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Popover open={searchOpen} onOpenChange={setSearchOpen}>
              ...
              <PopoverContent className="w-80 p-0">
                <Command>
                  <CommandInput placeholder="Buscar pacientes, consultas..." value={searchQuery} onValueChange={handleSearch}/>
                  <CommandList>
            ...
            {/* Add Appointment */}
            {onAddAppointment && (<Button onClick={onAddAppointment} size="sm">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            {totalValue > 0 && (<div className="flex items-center space-x-1 text-sm">
