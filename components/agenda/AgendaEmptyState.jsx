...
import { Calendar, Plus, Search, Filter, CalendarDays, Clock, Users } from 'lucide-react';
const AgendaEmptyState = ({ viewType, onAddAppointment, onClearFilters, hasFilters = false, date = new Date() }) => {
    ...
    return (<Card className="p-8 text-center">
      <div className="max-w-md mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          {onAddAppointment && (<Button onClick={onAddAppointment} className="flex items-center gap-2">
              <Plus className="w-4 h-4"/>
              Novo Agendamento
            </Button>)}
          
          {hasFilters && onClearFilters && (<Button variant="outline" onClick={onClearFilters} className="flex items-center gap-2">
        ...
        {/* Quick Stats */}
        {viewType !== 'list' && (<div className="pt-4 border-t border-border">
