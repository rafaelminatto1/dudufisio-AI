...
const SimpleWaitlistModal = ({ isOpen, onClose, onSave, patients, therapists, initialPatientId }) => {
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              ...
              <Input id="startFrom" type="date" value={formData.preferredStartFrom} onChange={(e) => setFormData(prev => ({ ...prev, preferredStartFrom: e.target.value }))}/>
            </div>
            <div className="space-y-2">
              <Label htmlFor="startTo">Data final</Label>
              <Input id="startTo" type="date" value={formData.preferredStartTo} onChange={(e) => setFormData(prev => ({ ...prev, preferredStartTo: e.target.value }))}/>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea id="notes" placeholder="Observações sobre o paciente..." value={formData.notes} onChange={(e) => setFormData(prev => ({ ...prev, notes: e.target.value }))} rows={3}/>
          </div>
