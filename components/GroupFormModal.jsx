...
const GroupFormModal = ({ isOpen, onClose, onSave, mode, initialName = '' }) => {
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md" onClick={e => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit}>
          <main className="p-6">
            ...
            <input id="group-name" type="text" value={name} onChange={(e) => setName(e.target.value)} className="mt-1 w-full p-2 border border-slate-300 rounded-lg" required autoFocus/>
