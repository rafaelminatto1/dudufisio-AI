          ...
          <section>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                ...
                <div className="md:col-span-2 flex items-start space-x-3 mt-4 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                    <input type="checkbox" id="consentGiven" name="consentGiven" checked={formData.consentGiven} onChange={e => setFormData(prev => ({ ...prev, consentGiven: e.target.checked }))} className="h-5 w-5 rounded border-gray-300 text-sky-600 focus:ring-sky-500 mt-1"/>
