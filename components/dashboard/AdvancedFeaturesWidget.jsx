...
export const AdvancedFeaturesWidget = () => {
    ...
    return (<div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {features.map((feature, idx) => {
            ...
            return (<button key={idx} onClick={() => navigate(feature.route)} className={`p-5 rounded-lg bg-gradient-to-br ${feature.color} text-white hover:shadow-lg transition-all transform hover:-translate-y-1`}>
