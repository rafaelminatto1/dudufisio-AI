...
const StatCard = ({ title, value, icon, change, changeType, subtitle }) => {
    ...
    return (<div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="mt-2 flex items-center text-sm">
        {change && (<div className={`flex items-center font-semibold ${changeColor}`}>
        ...
        {!change && subtitle && (<p className="text-slate-500">{subtitle}</p>)}
      </div>
    </div>);
};
