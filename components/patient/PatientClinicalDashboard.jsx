...
const KpiCard = ({ title, value, icon, subtitle }) => (<div className="bg-white p-4 rounded-xl shadow-sm">
...
const PatientClinicalDashboard = ({ patient, appointments, notes, plan, onMapClick, onPointClick }) => {
    ...
    return (<div className="space-y-6">
            ...
            <InfoCard title="Mapa de Dor Interativo" icon={<MapPin />}>
                ...
                <PainMap points={patient.painPoints || []} onMapClick={onMapClick} onPointClick={onPointClick}/>
            </InfoCard>
