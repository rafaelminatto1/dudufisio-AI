...
import { Shield, Activity, Users, Brain, TrendingUp, FileText } from 'lucide-react';
...
export const QuickActionsCard: React.FC<QuickActionsCardProps> = ({ patientId, patientName }) => {
        ...
        {actions.map((action, idx) => {
          ...
          return (
            <button
              ...
              className={`p-4 rounded-lg text-left transition ${colorClasses[action.color]}`}
            >
