...
const AppointmentCard = ({ appointment, therapistName }) => {
    ...
    return (<div className={`bg-white p-4 rounded-xl shadow-sm border-l-4 ${isPast ? 'border-slate-300' : 'border-teal-500'}`}>
