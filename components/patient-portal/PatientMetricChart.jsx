...
const PatientMetricChart = ({ metric, notes }) => {
    ...
    return (<InfoCard title={`Sua Evolução: ${metric.name}`} icon={<LineChartIcon />}>
            <div className="h-64 -ml-4">
                <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={chartData} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
                        ...
                        <Tooltip contentStyle={{ backgroundColor: 'white', border: '1px solid #e2e8f0', borderRadius: '0.5rem' }} labelStyle={{ color: '#1e293b', fontWeight: 'bold' }} formatter={(value) => [`${value} ${metric.unit || ''}`, metric.name]}/>
