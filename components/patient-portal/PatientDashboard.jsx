...
import { Calendar, Activity, Award, TrendingUp, Video } from 'lucide-react';
...
export const PatientDashboard = ({ patientId }) => {
    ...
    return (<div className="p-6 space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
          ...
          <div className="mt-2">
            <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
              <div className="bg-gradient-to-r from-blue-500 to-purple-500 h-2 rounded-full transition-all" style={{ width: `${progressPercentage}%` }}></div>
            </div>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        ...
        ].map((achievement, idx) => (<div key={idx} className={`p-4 rounded-lg text-center ${achievement.unlocked
