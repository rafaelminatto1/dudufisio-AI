...
const SportsAssessmentForm = ({ patientId, onBack }) => {
    ...
    return (<form onSubmit={handleSubmit(onSubmit)} className="space-y-6 animate-fade-in-fast">
      <div className="p-6 bg-white rounded-2xl shadow-sm">
        <div className="space-y-6">
            ...
            <fieldset className={fieldsetStyle}>
                ...
                {fields.map((field, index) => (<div key={field.id} className="flex items-center gap-2 animate-fade-in-fast">
