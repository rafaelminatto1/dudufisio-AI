...
import { MoreHorizontal, Edit, Trash2, Copy, Eye, Users } from 'lucide-react';
...
export const createProtocolColumns = (onEdit, onDelete, onView, onDuplicate) => [
    {
        accessorKey: 'name',
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return (<Badge className={intensityColors[intensity]}>
    ...
    },
    {
        ...
        cell: ({ row, table }) => {
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem onClick={() => meta?.onDelete(protocol)} className="text-red-600">
