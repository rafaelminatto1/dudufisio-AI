...
└── infrastructure/           # External integrations and data persistence
    ...
    └── gateways/           # Payment gateways (StripeGateway, PagarmeGateway)
```
...
- **Payment Gateways**: Stripe and Pagar.me integrations with webhook support
...
### Pagar.me Setup
```typescript
import { PagarmeGateway } from './lib/financial/infrastructure/gateways/PagarmeGateway';
...
- Stripe and Pagar.me for excellent payment APIs
