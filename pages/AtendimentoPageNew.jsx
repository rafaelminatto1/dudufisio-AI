...
const AtendimentoPageNew = () => {
    ...
    const handleSaveNote = async () => {
        ...
        try {
            ...
            await soapNoteService.saveNote(noteData);
            setSaveStatus('saved');
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center space-x-4">
                            <Button variant="ghost" size="sm" onClick={() => navigate('/agenda')} className="flex items-center space-x-2">
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <TiptapEditor value={subjective} onChange={setSubjective} placeholder="Como o paciente se sente? Quais são as queixas principais?" minHeight="100px"/>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <TiptapEditor value={objective} onChange={setObjective} placeholder="Achados objetivos, testes realizados, observações clínicas..." minHeight="100px"/>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <TiptapEditor value={assessment} onChange={setAssessment} placeholder="Diagnóstico clínico, análise dos achados..." minHeight="100px"/>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <TiptapEditor value={plan} onChange={setPlanState} placeholder="Plano de tratamento, próximos passos, exercícios prescritos..." minHeight="100px"/>
                                </div>
                            </CardContent>
                        </Card>
                    </div>
