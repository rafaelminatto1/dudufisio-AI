    ...
    return (<div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Button onClick={() => navigate('/dashboard')} className="w-full sm:w-auto bg-indigo-600 hover:bg-indigo-700">
        ...
        <div className="mt-8">
          <p className="text-sm text-slate-500">
            Precisa de ajuda?{' '}
            <a href="mailto:suporte@dudufisio.com" className="text-indigo-600 hover:text-indigo-700 font-medium underline">
