...
import { MessageSquare, Zap, Settings, BarChart3, CheckCircle2, XCircle, AlertCircle, } from 'lucide-react';
...
export const WhatsAppManagementPage = () => {
    const [clinicId, setClinicId] = useState('1'); // TODO: Get from context/auth
    // Verificar configuração
    const isConfigured = Boolean(process.env.WHATSAPP_ACCESS_TOKEN &&
    ...
    return (<div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {isConfigured ? (<Badge className="bg-green-100 text-green-800">
