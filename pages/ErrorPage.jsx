...
const ErrorPage = ({ error: propError, resetError }) => {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-amber-50 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
          <div className="space-y-4">
            ...
            {errorStack && (<details className="text-left">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Button onClick={handleReload} className="w-full bg-indigo-600 hover:bg-indigo-700">
            ...
            <Button onClick={handleClearCache} variant="outline" className="w-full text-red-600 hover:text-red-700 hover:bg-red-50">
              <RefreshCw className="w-4 h-4 mr-2"/>
              Limpar Cache
            </Button>
          </div>
        ...
        <div className="text-center">
          ...
          <Button variant="ghost" className="text-indigo-600 hover:text-indigo-700" onClick={() => window.location.href = 'mailto:suporte@dudufisio.com?subject=Erro%20na%20Aplicação'}>
