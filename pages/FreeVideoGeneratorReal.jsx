...
import { z } from "zod";
import { Film, Wand2, Sparkles, CheckCircle, Plus, CheckCheck, Download, Share2, RotateCcw, Brain, Video } from 'lucide-react';
...
const generateCustomVideo = (exerciseName, modality, tool) => {
...
const generateCustomDuration = (exerciseName, modality) => {
...
const FreeVideoGeneratorReal = () => {
    ...
    const toolInfo = TOOLS[watchTool];
    ...
    const startRealGeneration = useCallback(() => {
        ...
        const realPrompt = `Cena cinematográfica em tatame profissional de artes marciais. Dois atletas vestindo kimonos (branco e azul) demonstrando ${values.exerciseName} em ${MODALITIES[values.modality]}. Câmera fixa em ângulo frontal superior. Iluminação natural com luz lateral. Movimento em velocidade normal seguido de repetição em câmera lenta mostrando detalhes da técnica e pegadas corretas. Ambiente limpo, tatame azul profissional. HD, 30fps, 10 segundos.`;
    ...
    return (<div className="space-y-6">
      <PageHeader title="Geração REAL de Vídeos com IA" subtitle="Sistema que gera vídeos baseados no seu prompt específico!"/>
          ...
          <CardContent>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                <FormField control={form.control} name="exerciseName" render={({ field }) => (<FormItem>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <FormField control={form.control} name="modality" render={({ field }) => (<FormItem>
                        ...
                        <Select onValueChange={field.onChange} value={field.value}>
                          ...
                          <SelectContent>
                            {Object.entries(MODALITIES).map(([key, mod]) => (<SelectItem key={key} value={key}>
                                {mod}
                              </SelectItem>))}
                          </SelectContent>
                        </Select>
                  ...
                  <FormField control={form.control} name="tool" render={({ field }) => (<FormItem>
                        ...
                        <Select onValueChange={field.onChange} value={field.value}>
                          ...
                          <SelectContent>
                            {Object.entries(TOOLS).map(([key, tool]) => (<SelectItem key={key} value={key}>
                ...
                <Button type="submit" className="w-full bg-purple-600 hover:bg-purple-700" size="lg" disabled={isGenerating}>
                  {isGenerating ? (<>
      ...
      {/* STEP 2: GENERATING */}
      {currentStep === 'generating' && (<Card className="border-2 border-purple-500">
          <CardHeader>
            <CardTitle className="flex items-center">
              ...
              <div className="text-center space-y-4">
                <div className="relative">
                  <div className="w-24 h-24 mx-auto">
                    <svg className="animate-spin" viewBox="0 0 100 100">
                      ...
                      <circle cx="50" cy="50" r="45" fill="none" stroke="#8b5cf6" strokeWidth="8" strokeDasharray="283" strokeDashoffset={283 - (283 * generationProgress) / 100} transform="rotate(-90 50 50)"/>
                    </svg>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Analisando: "{pendingFormData?.exerciseName}" em {MODALITIES[pendingFormData?.modality]}
                  </p>
                </div>
      ...
      {/* STEP 3: VIDEO READY */}
      {currentStep === 'video_ready' && (<Card className="border-2 border-green-500">
          <CardHeader>
            <CardTitle className="flex items-center">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="relative bg-black rounded-lg overflow-hidden">
                <video className="w-full h-64 object-cover" poster={generatedThumbnailUrl} controls preload="metadata">
              ...
              <div className="flex items-center justify-between">
                <div className="text-sm text-muted-foreground">
                  ...
                  <p><strong>Modalidade:</strong> {MODALITIES[pendingFormData?.modality]}</p>
            ...
            {/* Action Buttons */}
            <div className="grid grid-cols-2 gap-4">
              <Button variant="outline" size="lg" onClick={handleRegenerateVideo} disabled={isGenerating} className="h-20 flex-col space-y-2">
              ...
              <Button size="lg" onClick={handleAcceptVideo} className="h-20 bg-green-600 hover:bg-green-700 flex-col space-y-2">
      ...
      {/* STEP 4: SUCCESS */}
      {currentStep === 'success' && (<Card className="border-2 border-green-500 bg-gradient-to-br from-green-50 to-emerald-50">
          <CardHeader>
          ...
          <CardContent className="space-y-6">
            {/* Video Preview */}
            {generatedVideoUrl && (<div className="space-y-4">
                <h4 className="font-semibold">Seu Vídeo Final:</h4>
                <div className="relative bg-black rounded-lg overflow-hidden">
                  <video className="w-full h-48 object-cover" poster={generatedThumbnailUrl} controls>
                    <source src={generatedVideoUrl} type="video/mp4"/>
                  </video>
                </div>
              </div>)}
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Button onClick={() => (window.location.href = '/exercise-library')} size="lg" className="h-16 bg-green-600 hover:bg-green-700">
                <div className="text-center">
      ...
      {currentStep !== 'success' && (<Card className="bg-gradient-to-br from-purple-50 to-blue-50">
          <CardHeader>
