...
import { columns } from '../components/patients/PatientColumns';
...
const PatientListPage = () => {
    ...
    return (<main className="min-h-screen bg-slate-50 py-8" role="main">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          ...
          <Button onClick={handleCreatePatient} className="bg-sky-500 hover:bg-sky-600">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm">
          <DataTable columns={columns} data={patients} meta={{
