...
import { SoapNote, Appointment, TreatmentPlan, Patient, TrackedMetric, Condition, MedicalReport, Project, PainPoint } from '../types';
...
const PatientDetailPage: React.FC = () => {
    ...
    const fetchPatientSpecificData = useCallback(async () => {
        ...
        setIsLoading(true);
        try {
            const [patientData, notesData, planData, reportsData, allProjects, appointmentsData] = await Promise.all([
