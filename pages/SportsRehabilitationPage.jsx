...
import { ArrowLeft, Activity, Target, TrendingUp, Zap, Calendar, BarChart3 } from 'lucide-react';
import { sportsRehabServiceSupabase } from '../services/sports/sportsRehabServiceSupabase';
import { toast } from 'react-toastify';
import { supabase } from '../lib/supabase';
export const SportsRehabilitationPage = () => {
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <div className="flex gap-4 justify-center">
              <button onClick={() => navigate(-1)} className="px-6 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition">
                Voltar
              </button>
              <button onClick={handleCreateProfile} className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
    ...
    return (<div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
              <div className="bg-green-600 h-2 rounded-full transition-all" style={{ width: `${progression?.overallProgress || 0}%` }}/>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            athleteProfile.dominantSide === 'left' ? 'Esquerdo' : 'Ambos'}
              ...
              {athleteProfile.targetReturnDate && (<div className="flex justify-between py-2">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            {metrics.length > 0 ? (<div className="space-y-3">
                {metrics.slice(0, 5).map((metric) => (<div key={metric.id} className="border-b pb-3 last:border-0">
                    ...
                    <div className="flex items-center gap-2 text-xs text-gray-600">
                      ...
                      {metric.trend && (<>
                          <span>•</span>
                          <span className={metric.trend === 'improving' ? 'text-green-600' :
        ...
        <div className="mt-6 bg-white rounded-lg shadow-md p-6">
          ...
          {sessions.length > 0 ? (<div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {sessions.slice(0, 5).map((session) => (<tr key={session.id} className="border-b last:border-0">
                      ...
                      <td className="py-3">
                        <span className={`text-sm font-medium ${(session.painLevel || 0) > 5 ? 'text-red-600' :
