...
import { X, User, Clock, FileText, ArrowLeft } from 'lucide-react';
...
const SessionFormPage = ({ appointmentId, onClose }) => {
    ...
    const [selectedNoteForRepeat, setSelectedNoteForRepeat] = useState(null);
    ...
    const handleRepeatConduct = (note) => {
        setSelectedNoteForRepeat(note);
        setIsRepeatModalOpen(true);
    };
    const handleConfirmRepeatConduct = async (noteData) => {
    ...
    return (<>
        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-7xl max-h-[95vh] flex flex-col">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <div className="flex items-center space-x-4 mt-2 text-sm text-slate-600">
                  ...
                  {therapist && (<div className="flex items-center space-x-1">
          ...
          <div className="flex-1 overflow-hidden flex flex-col lg:flex-row">
            ...
            <div className="lg:w-2/3 p-6 overflow-y-auto border-r border-slate-200">
              <SessionForm patient={patient} onSave={handleSaveNote} onCancel={onClose} isLoading={isSaving} previousNote={patientNotes[0] || null} onRepeatConduct={() => patientNotes[0] && handleRepeatConduct(patientNotes[0])}/>
            </div>
            ...
            <div className="lg:w-1/3 p-6 overflow-y-auto bg-slate-50">
              <div className="space-y-6">
                ...
                {/* Métricas */}
                <PatientMetrics patient={patient} appointments={allAppointments}/>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-slate-200 bg-white">
            <div className="p-6">
              <SessionHistory patientNotes={patientNotes} onRepeatConduct={handleRepeatConduct}/>
            </div>
          </div>
        </div>
      </div>
      ...
      {selectedNoteForRepeat && (<RepeatConductModal isOpen={isRepeatModalOpen} onClose={() => {
                setIsRepeatModalOpen(false);
                setSelectedNoteForRepeat(null);
            }} onConfirm={handleConfirmRepeatConduct} previousNote={selectedNoteForRepeat} patientName={patient.name}/>)}
    </>);
};
