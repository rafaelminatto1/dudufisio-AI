...
import { User, Shield, Bell, KeyRound, CreditCard, ExternalLink } from 'lucide-react';
import PageHeader from '../components/PageHeader';
// 🚀 Componente SettingsCard memoizado
const SettingsCard = memo(({ icon, title, description, children }) => (<div className="bg-white rounded-2xl shadow-sm overflow-hidden">
        <div className="p-6">
...
const SettingsPage = () => {
    return (<>
            <PageHeader title="Configurações" subtitle="Gerencie seu perfil, segurança e preferências de notificação."/>

            <div className="space-y-8">
                <SettingsCard icon={<User className="w-6 h-6"/>} title="Perfil" description="Atualize suas informações pessoais e foto de perfil.">
                ...
                <SettingsCard icon={<Shield className="w-6 h-6"/>} title="Segurança" description="Gerencie sua senha e autenticação de múltiplos fatores (MFA).">
                ...
                <SettingsCard icon={<CreditCard className="w-6 h-6"/>} title="Legal e Assinatura" description="Consulte os termos de uso, política de privacidade e gerencie seu plano.">
                     <div className="space-y-4">
                 ...
                 <SettingsCard icon={<Bell className="w-6 h-6"/>} title="Notificações" description="Escolha como você deseja ser notificado sobre eventos importantes.">
                    <div className="space-y-4">
