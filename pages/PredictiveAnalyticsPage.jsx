...
export const PredictiveAnalyticsPage = () => {
    ...
    const handleGeneratePrediction = async () => {
        ...
        try {
            setLoading(true);
            const result = await predictiveAnalyticsServiceSupabase.predictTreatmentOutcome(patientId, treatmentType);
    ...
    return (<div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="flex gap-4 items-end">
            <div className="flex-1">
              ...
              <select value={treatmentType} onChange={(e) => setTreatmentType(e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" aria-label="Tipo de Tratamento" title="Selecione o tipo de tratamento">
            ...
            <button onClick={handleGeneratePrediction} disabled={loading} className="px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition disabled:opacity-50 flex items-center gap-2">
        ...
        {prediction && (<>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              <div className="space-y-3">
                {prediction.factors.map((factor, idx) => (<div key={idx} className="border border-gray-200 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`text-xs px-2 py-1 rounded ${factor.impact === 'positive' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
                    ...
                    <div className="mt-2 bg-gray-200 rounded-full h-2 overflow-hidden">
                      <div className="bg-indigo-600 h-2 rounded-full transition-all" data-width={factor.importance * 100}/>
                    </div>
                  </div>))}
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {prediction.alternativeScenarios.map((scenario, idx) => (<div key={idx} className="border-2 border-gray-200 rounded-lg p-4">
            ...
            <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-6">
              ...
              <ul className="space-y-2">
                {prediction.recommendedActions.map((action, idx) => (<li key={idx} className="text-sm text-indigo-800 flex items-start gap-2">
        ...
        {/* Info Banner */}
        {!prediction && (<div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
