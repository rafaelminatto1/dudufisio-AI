...
const SoapNoteCard = ({ note }) => (<div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <InfoCard title="Plano de Treino e Anotações" icon={<Notebook />}>
                        <textarea rows={8} className="w-full p-2 border border-slate-300 rounded-lg text-sm" placeholder="Digite aqui o plano de treino, observações e anotações sobre este cliente..."/>
