...
const StatCard = ({ title, value, icon }) => (<div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-lg transition-shadow duration-300">
...
const EducatorDashboardPage = () => {
    const { user } = useAuth();
    return (<>
            <PageHeader title={`Boas-vindas, ${user?.name.split(' ')[0] || user?.name}!`} subtitle="Acompanhe os pacientes encaminhados e seus progressos."/>
