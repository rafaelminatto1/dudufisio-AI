...
export const QualityAssuranceDashboardPage = () => {
    ...
    return (<div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Compliance Overview */}
        {complianceReport && (<div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {metrics.map((metric) => (<div key={metric.metricId} className="border border-gray-200 rounded-lg p-4">
                ...
                <div className="flex items-end justify-between">
                  ...
                  <div className="text-right">
                    <p className={`text-sm font-medium ${metric.currentValue >= metric.targetValue ? 'text-green-600' : 'text-orange-600'}`}>
                ...
                <div className="mt-3 bg-gray-100 rounded-full h-2 overflow-hidden">
                  <div className={`h-2 rounded-full transition-all ${metric.currentValue >= metric.targetValue ? 'bg-green-600' : 'bg-orange-500'}`} data-width={Math.min(100, (metric.currentValue / metric.targetValue) * 100)}/>
                </div>
              </div>))}
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                {auditLogs.slice(0, 10).map((log) => (<tr key={log.entryId} className="border-b last:border-0">
                    ...
                    <td className="py-3">
                      <span className={`text-xs px-2 py-1 rounded ${log.result === 'success' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
                        {log.result}
                      </span>
                    </td>
                  </tr>))}
