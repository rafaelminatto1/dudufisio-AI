...
import { Brain, TrendingUp, Users, Activity, AlertTriangle, Target, Zap, BarChart3, Lightbulb, CheckCircle2, ArrowUpRight, ArrowDownRight, Sparkles, Bot, RefreshCw, Download, Filter, ChevronRight, Star, Award, Heart } from 'lucide-react';
...
const AiAnalyticsPage = () => {
    ...
    const analyzeTreatmentEffectiveness = async () => {
    ...
    const generateOperationalInsights = async () => {
    ...
    return (<PermissionGuard permission="analytics:read">
      <div className="p-6 max-w-7xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          <PageHeader title="IA & Analytics" subtitle="Insights inteligentes e an�lises preditivas para sua cl�nica"/>

          <div className="flex items-center gap-3">
            <div className="text-sm text-gray-600">
              �ltima atualiza��o: {lastUpdate}
            </div>
            <button onClick={refreshAIAnalytics} disabled={isGeneratingInsights} className="flex items-center gap-2 px-4 py-2 bg-sky-600 text-white rounded-lg hover:bg-sky-700 transition-colors disabled:opacity-50">
              {isGeneratingInsights ? (<RefreshCw className="w-4 h-4 animate-spin"/>) : (<Sparkles className="w-4 h-4"/>)}
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  {predictions.slice(0, 3).map((prediction) => (<div key={prediction.id} className="border border-gray-200 rounded-lg p-4">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 text-xs">
                            ...
                            <span className={`px-2 py-1 rounded-full ${prediction.impact === 'high' ? 'bg-red-100 text-red-700' :
                prediction.impact === 'medium' ? 'bg-yellow-100 text-yellow-700' :
                    'bg-green-100 text-green-700'}`}>
                        ...
                        {prediction.actionable && (<button className="ml-4 text-sky-600 hover:text-sky-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <div className="p-6">
                  <div className="space-y-4">
                    {operationalInsights.slice(0, 3).map((insight, index) => (<div key={index} className="flex items-center justify-between">
                        <div>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <div className="p-6">
                  <div className="space-y-4">
                    {treatmentEffectiveness.slice(0, 3).map((treatment, index) => (<div key={index} className="border-l-4 border-sky-500 pl-4">
                        <div className="flex items-center justify-between">
                          <div>
                          ...
                          <div className="text-right">
                            ...
                            <div className="flex gap-1">
                              {[...Array(5)].map((_, i) => (<Star key={i} className={`w-3 h-3 ${i < Math.floor(treatment.patientSatisfaction / 20)
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              ...
              <div className="p-6">
                <div className="space-y-6">
                  {predictions.map((prediction) => (<div key={prediction.id} className="border border-gray-200 rounded-lg p-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          {prediction.value && prediction.previousValue && (<div className="flex items-center gap-4 mb-4">
                          ...
                          {prediction.actionable && prediction.recommendations.length > 0 && (<div className="border-t border-gray-200 pt-4">
                              <h5 className="font-medium text-gray-900 mb-2 flex items-center gap-2">
                                <Lightbulb className="w-4 h-4 text-yellow-500"/>
                                Recomenda��es de A��o:
                              </h5>
                              <ul className="space-y-1">
                                {prediction.recommendations.map((rec, index) => (<li key={index} className="flex items-start gap-2 text-sm text-gray-700">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              ...
              <div className="p-6">
                <div className="grid gap-6">
                  {patientInsights.map((insight) => (<div key={insight.patientId} className="border border-gray-200 rounded-lg p-6">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                        <div className="text-center">
                          <div className="relative w-16 h-16 mx-auto mb-2">
                            <svg className="w-16 h-16 transform -rotate-90">
                              ...
                              <circle cx="32" cy="32" r="28" stroke="#3b82f6" strokeWidth="4" fill="none" strokeDasharray={`${insight.predictions.adherence * 1.76} 176`}/>
                            </svg>
                        ...
                        <div className="text-center">
                          <div className="relative w-16 h-16 mx-auto mb-2">
                            <svg className="w-16 h-16 transform -rotate-90">
                              <circle cx="32" cy="32" r="28" stroke="#e5e7eb" strokeWidth="4" fill="none"/>
                              <circle cx="32" cy="32" r="28" stroke="#10b981" strokeWidth="4" fill="none" strokeDasharray={`${insight.predictions.outcome * 1.76} 176`}/>
                            </svg>
                            <div className="absolute inset-0 flex items-center justify-center">
                        ...
                        <div className="text-center">
                          <div className="relative w-16 h-16 mx-auto mb-2">
                            <svg className="w-16 h-16 transform -rotate-90">
                              <circle cx="32" cy="32" r="28" stroke="#e5e7eb" strokeWidth="4" fill="none"/>
                              <circle cx="32" cy="32" r="28" stroke="#ef4444" strokeWidth="4" fill="none" strokeDasharray={`${insight.predictions.dropoutRisk * 1.76} 176`}/>
                            </svg>
                            <div className="absolute inset-0 flex items-center justify-center">
                        ...
                        <div className="text-center">
                          <div className="relative w-16 h-16 mx-auto mb-2">
                            <svg className="w-16 h-16 transform -rotate-90">
                              <circle cx="32" cy="32" r="28" stroke="#e5e7eb" strokeWidth="4" fill="none"/>
                              <circle cx="32" cy="32" r="28" stroke="#8b5cf6" strokeWidth="4" fill="none" strokeDasharray={`${insight.predictions.recoveryTime * 1.76} 176`}/>
                            </svg>
                            <div className="absolute inset-0 flex items-center justify-center">
                      ...
                      <div className="border-t border-gray-200 pt-4">
                        ...
                        <div className="space-y-2">
                          {insight.recommendations.map((rec, index) => (<div key={index} className="flex items-start gap-2">
                              <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5 flex-shrink-0"/>
          ...
          <TabsContent value="treatments" className="space-y-6">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              ...
              <div className="p-6">
                <div className="space-y-6">
                  {treatmentEffectiveness.map((treatment, index) => (<div key={index} className="border border-gray-200 rounded-lg p-6">
                      <div className="flex items-start justify-between mb-4">
                        <div>
                        ...
                        <div className="flex items-center gap-2">
                          {getTrendIcon(treatment.trend)}
                          <span className={`px-3 py-1 rounded-full text-sm font-medium ${treatment.successRate >= 90 ? 'bg-green-100 text-green-700' :
                treatment.successRate >= 80 ? 'bg-blue-100 text-blue-700' :
                    treatment.successRate >= 70 ? 'bg-yellow-100 text-yellow-700' :
                      ...
                      <div className="space-y-3 mb-6">
                        <div>
                          ...
                          <div className="w-full bg-gray-200 rounded-full h-2">
                            <div className="bg-sky-600 h-2 rounded-full" style={{ width: `${treatment.successRate}%` }}/>
                          </div>
                        </div>
                        <div>
                          <div className="flex justify-between text-sm text-gray-600 mb-1">
                          ...
                          <div className="w-full bg-gray-200 rounded-full h-2">
                            <div className="bg-green-600 h-2 rounded-full" style={{ width: `${treatment.patientSatisfaction}%` }}/>
                          </div>
                        </div>
                        <div>
                          <div className="flex justify-between text-sm text-gray-600 mb-1">
                          ...
                          <div className="w-full bg-gray-200 rounded-full h-2">
                            <div className="bg-orange-600 h-2 rounded-full" style={{ width: `${treatment.costEffectiveness}%` }}/>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="border-t border-gray-200 pt-4">
                        ...
                        <div className="space-y-2">
                          {treatment.recommendations.map((rec, index) => (<div key={index} className="flex items-start gap-2">
                              <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5 flex-shrink-0"/>
                              <span className="text-sm text-gray-700">{rec}</span>
                            </div>))}
                        </div>
          ...
          <TabsContent value="operations" className="space-y-6">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              ...
              <div className="p-6">
                <div className="grid gap-6">
                  {operationalInsights.map((insight, index) => (<div key={index} className="border border-gray-200 rounded-lg p-6">
                      <div className="flex items-center justify-between mb-4">
                        <h4 className="text-lg font-semibold text-gray-900">{insight.metric}</h4>
                        <div className="flex items-center gap-2">
                          {getTrendIcon(insight.trend)}
                          <span className={`px-3 py-1 rounded-full text-sm font-medium ${insight.urgency === 'critical' ? 'bg-red-100 text-red-700' :
                insight.urgency === 'high' ? 'bg-orange-100 text-orange-700' :
                    insight.urgency === 'medium' ? 'bg-yellow-100 text-yellow-700' :
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
                        ...
                        <div className="text-center">
                          <div className={`text-3xl font-bold ${insight.variance > 0 ? 'text-green-600' : 'text-red-600'}`}>
