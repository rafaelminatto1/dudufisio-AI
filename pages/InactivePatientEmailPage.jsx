...
const InactivePatientEmailPage = () => {
    ...
    return (<>
            <PageHeader title="Gerador de E-mail para Pacientes Inativos" subtitle="Crie um e-mail de reengajamento para pacientes que não retornam há algum tempo."/>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm">
                    ...
                    <div className="bg-slate-50 p-4 rounded-lg min-h-[500px] overflow-y-auto border border-slate-200">
                        ...
                        {!isLoading && !emailHtml && (<div className="text-center text-slate-500 flex flex-col justify-center items-center h-full">
                        ...
                        {emailHtml && (<iframe srcDoc={emailHtml} title="Preview do E-mail" className="w-full h-[500px] border-0" sandbox="allow-same-origin"/>)}
                    </div>
                </div>
            </div>
        </>);
