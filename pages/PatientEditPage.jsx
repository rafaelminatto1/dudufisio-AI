...
import { ArrowLeft, Save, User, MapPin, Phone, Heart, FileText, Activity, DollarSign, TrendingUp, AlertCircle, CheckCircle2, } from 'lucide-react';
...
const PatientEditPage = () => {
    ...
    return (<div className="min-h-screen bg-slate-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              {!isNewPatient && (<p className="text-slate-600 mt-1">
          ...
          <div className="flex items-center space-x-3">
            {!isNewPatient && (<Badge className={getStatusColor(currentPatient?.status || 'Active')}>
        ...
        {!isNewPatient && currentPatient && (<div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <Card>
              ...
              <CardContent>
                ...
                <Progress value={currentPatient.sessionTracking?.totalSessions ?
                ((currentPatient.sessionTracking.completedSessions || 0) / currentPatient.sessionTracking.totalSessions) * 100 : 0} className="mt-2"/>
            ...
            <Card>
              ...
              <CardContent>
                ...
                {mockPatient.financialInfo.hasOutstandingBalance && (<div className="flex items-center mt-2">
