...
const Section = ({ title, children }) => (<div className="mb-8">
...
const LegalPage = () => {
    return (<>
            <PageHeader title="Termos e Privacidade" subtitle="Nossa política de privacidade e termos de uso do FisioFlow."/>
