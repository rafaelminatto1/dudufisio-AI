...
export const PatientPortalPage = () => {
    ...
    const [patientId, setPatientId] = useState(''); // TODO: Get from auth
    const tabs = [
    ...
    return (<div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-white dark:bg-gray-800 border-b dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex gap-8">
            {tabs.map((tab) => {
            const Icon = tab.icon;
            return (<button key={tab.id} onClick={() => setActiveTab(tab.id)} className={`flex items-center gap-2 px-4 py-4 border-b-2 transition-colors ${activeTab === tab.id
      ...
      <main className="max-w-7xl mx-auto">
        ...
        {activeTab === 'appointments' && (<div className="p-6">
