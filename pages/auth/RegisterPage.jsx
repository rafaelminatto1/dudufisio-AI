...
const RegisterPage = ({ onSuccess, onBack }) => {
          ...
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="name" name="name" type="text" value={formData.name} onChange={handleInputChange} placeholder="Seu nome completo" className={validationErrors.name ? 'border-red-500' : ''}/>
              ...
              <div className="space-y-2">
                ...
                <Input id="email" name="email" type="email" value={formData.email} onChange={handleInputChange} placeholder="seu@email.com" className={validationErrors.email ? 'border-red-500' : ''}/>
              ...
              <div className="space-y-2">
                ...
                <Input id="phone" name="phone" type="tel" value={formData.phone} onChange={handleInputChange} placeholder="+55 11 99999-9999" className={validationErrors.phone ? 'border-red-500' : ''}/>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input id="password" name="password" type={showPassword ? 'text' : 'password'} value={formData.password} onChange={handleInputChange} placeholder="Sua senha" className={validationErrors.password ? 'border-red-500 pr-10' : 'pr-10'}/>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input id="confirmPassword" name="confirmPassword" type={showConfirmPassword ? 'text' : 'password'} value={formData.confirmPassword} onChange={handleInputChange} placeholder="Confirme sua senha" className={validationErrors.confirmPassword ? 'border-red-500 pr-10' : 'pr-10'}/>
            ...
            <CardFooter className="flex flex-col space-y-4">
              ...
              <div className="text-sm text-center text-gray-600">
                Já tem uma conta?{' '}
                <button type="button" onClick={onBack} className="text-indigo-600 hover:text-indigo-700 font-medium">
                  Fazer login
                </button>
              </div>
            </CardFooter>
