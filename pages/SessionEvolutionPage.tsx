...
const FormInput = memo<{label: string, name: keyof SessionEvolutionFormData, value: string, onChange: (e: React.ChangeEvent<HTMLInputElement>) => void, placeholder: string}>(
...
const SessionEvolutionPage: React.FC = () => {
    ...
    const isSubmitDisabled = useMemo(
        () => isLoading || !formData.relato_paciente.trim(),
        [isLoading, formData.relato_paciente]
    );
